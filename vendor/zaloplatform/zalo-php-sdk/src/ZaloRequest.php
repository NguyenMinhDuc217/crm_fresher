...
class ZaloRequest
{
    ...
    public function setAccessToken($accessToken)
    {
        ...
        // Added by Hieu Nguyen on 2021-11-05 to send access token in header to support new api rule
        $this->setHeaders(['access_token' => $this->accessToken]);
        // End Hieu Nguyen
    ...
    public function getParams()
    {
        ...
        // Commented out by Hieu Nguyen on 2021-11-05 to support new api rule
        /*$accessToken = $this->getAccessToken();
    ...
    public function getUrl()
    {
        ...
        if ($this->getMethod() !== 'POST') {
            ...
            // Commented out by Hieu Nguyen on 2022-12-30 to temporary support new API rule "Access token must be placed in header"
