...
class Vtiger_Module extends Vtiger_ModuleBasic {
	...
	// Added by Hieu Nguyen on 2018-09-04
	public function getDefaultBlock() {
		global $adb;

		$sql = "SELECT blockid FROM vtiger_blocks WHERE tabid = {$this->id} LIMIT 1";
		$defaultBlockId = $adb->getOne($sql);
		$defaultBlock = Vtiger_Block::getInstance($defaultBlockId, $this);
