...
class Vtiger_ModuleBasic {
	...
	function __create() {
		...
		if (!empty($parentTab)) {
            ...
            // Modified by Hieu Nguyen on 2019-11-05 to fix bug module creation failed when module is attached to a group menu that is not exist in vtiger_parenttabrel
            if ($menuInstance) {
