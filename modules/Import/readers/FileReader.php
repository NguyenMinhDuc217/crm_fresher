...
class Import_FileReader_Reader {
	...
	public function createTable() {
		...
		$columnsListQuery = 'id INT PRIMARY KEY AUTO_INCREMENT, status INT DEFAULT 0, error_reasons TEXT, recordid INT';	// Modified by Hieu Nguyen on 2021-10-15 to add column error_reason
		...
		$createTableQuery = 'CREATE TABLE '. $tableName . ' ('.$columnsListQuery.') ENGINE=InnoDB ';    // Modified table engine by Hieu Nguyen on 2020-08-04 to support db replication on latest MySQL
