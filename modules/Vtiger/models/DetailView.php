...
class Vtiger_DetailView_Model extends Vtiger_Base_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if (isReadonlyModule($moduleName)) {
			...
			$linkModelList['DETAILVIEW'] = removeButtons($linkModelList['DETAILVIEW'], ['LBL_DELETE', 'LBL_DUPLICATE']);
		}
	...
	public function getDetailViewRelatedLinks() {
		...
		foreach($relationModels as $relation) {
			// Added by Hieu Nguyen on 2022-07-26 to hide unsupported modules from subpanel
			if (isForbiddenFeature('Module' . $relation->get('relatedModuleName'))) {
				continue;
			}
			// End Hieu Nguyen
