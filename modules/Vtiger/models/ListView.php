...
class Vtiger_ListView_Model extends Vtiger_Base_Model {
	...
	public function getListViewLinks($linkParams) {
		...
		if ($moduleModel->isReadonlyModule()) { // Modifed by Hieu Nguyen on 2021-05-31 to boost performance
			$links['LISTVIEWBASIC'] = removeButtons($links['LISTVIEWBASIC'], ['LBL_ADD_RECORD']);
			$links['LISTVIEW'] = removeButtons($links['LISTVIEW'], ['LBL_IMPORT']);
		}
		// End Phu Vo
	...
	public function getListViewMassActions($linkParams) {
		...
		// Added by Phu Vo to handle readonly module list view links
		if ($moduleModel->isReadonlyModule()) { // Modifed by Hieu Nguyen on 2021-05-31 to boost performance
			$links['LISTVIEWMASSACTION'] = removeButtons($links['LISTVIEWMASSACTION'], ['LBL_EDIT', 'LBL_DELETE']);
		}
		// End Phu Vo
	...
	public function getAdvancedLinks(){
		...
		// Added by Phu Vo to handle readonly module advanced links
		if ($moduleModel->isReadonlyModule()) { // Modifed by Hieu Nguyen on 2021-05-31 to boost performance
			$advancedLinks = removeButtons($advancedLinks, ['LBL_LBL_IMPORT', 'LBL_FIND_DUPLICATES']);
		}
		// End Phu Vo
	...
	public function getBasicLinks(){
		...
		// Added by Phu Vo to handle readonly module basic links
		if ($moduleModel->isReadonlyModule()) { // Modifed by Hieu Nguyen on 2021-05-31 to boost performance
			$basicLinks = removeButtons($basicLinks, ['LBL_ADD_RECORD']);
		}
		// End Phu Vo
