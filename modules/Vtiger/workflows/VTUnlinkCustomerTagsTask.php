...
/*
	Workflow Task Unlink Customer Tags
	Author: Hieu Nguyen
	Date: 2021-12-07
	Purpose: handle workflow action to unlink tags from customer
*/

require_once('modules/com_vtiger_workflow/VTTaskManager.inc');
require_once('modules/com_vtiger_workflow/VTWorkflowUtils.php');

class VTUnlinkCustomerTagsTask extends VTTask {
	...
	public function doTask($entity) {
		VTTask::saveLog('[VTUnlinkCustomerTagsTask::doTask] Begin', $entity->getData());
		VTTask::saveLog('[VTUnlinkCustomerTagsTask::doTask] Workflow task info', $this);
		...
		// Unlink selected tags from customer
		...
		Vtiger_Tag_Model::deleteForRecord($customerId, $tags, 1, $customerType);

		// Finish task
		$util->revertUser();
		VTTask::saveLog('[VTUnlinkCustomerTagsTask::doTask] Finished');
	}
