...
class Vtiger_FindDuplicates_View extends Vtiger_List_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		// Modified by Hieu Nguyen on 2021-11-22 to fix bug can not click button next page in duplicated records list
		$rowCount = 0;
		
		foreach ($this->listViewEntries as $groupKey => $groupRecords) {
			$rowCount += count($groupRecords);
		}
		// End Hieu Nguyen
