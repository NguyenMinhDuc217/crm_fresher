...
class Vtiger_ExtensionViews_View extends Vtiger_Index_View {
	...
	function getDetailViewLink($moduleName, $recordId) {
        if ($moduleName == 'Events') $moduleName = 'Calendar';  // Added by Hieu Nguyen on 2020-02-17 to get the right Event's detail url
	...
	function showLogs(Vtiger_Request $request) {
        ...
        // Added by Hieu Nguyen on 2019-12-17 to prevent accessing Google Sync log if this feature is not available in current CRM package
