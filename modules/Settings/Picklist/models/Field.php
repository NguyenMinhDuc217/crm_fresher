...
class Settings_Picklist_Field_Model extends Vtiger_Field_Model {
    ...
    // Added by Hieu Nguyen on 2021-10-22 to check if a picklist field is supported in Picklist Editor
    static function isUnsupportedField($fieldName) {
        global $pickListEditorUnsupportedFields;
        return in_array($fieldName, $pickListEditorUnsupportedFields);
    }

    // Refactored by Hieu Nguyen on 2021-10-22
    public function isEditable() {
        global $pickListEditorUnsupportedFields;
        return !in_array($this->getName(), $pickListEditorUnsupportedFields);
    }
