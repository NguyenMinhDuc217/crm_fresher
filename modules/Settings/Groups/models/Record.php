...
class Settings_Groups_Record_Model extends Settings_Vtiger_Record_Model {
	...
	public function save() {
		...
		if ($mode == 'edit') {
			...
			$sql = 'INSERT INTO vtiger_groups(groupid, groupname, description, is_custom, member_ids_hash) VALUES (?,?,?,?,?)';
			$params = array($groupId, $this->getName(), $this->getDescription(), $this->get('is_custom'), $this->get('member_ids_hash'));
            // End Hieu Nguyen
        }
	...
	public static function getAll() {
		...
		$sql = 'SELECT * FROM vtiger_groups WHERE is_custom = 0';   // Modified by Hieu Nguyen on 2019-11-26 to non-custom groups only
		$params = array();
