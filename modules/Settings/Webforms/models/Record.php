...
class Settings_Webforms_Record_Model extends Settings_Vtiger_Record_Model {
	...
	public function getRecordLinks() {
		...
		$recordLinks = array(
				array(
						...
						'linkicon' => 'far fa-image icon-picture'
				),
				array(
						'linktype' => 'LISTVIEWRECORD',
						'linklabel' => 'LBL_EDIT',
						'linkurl' => $this->getEditViewUrl(),
						'linkicon' => 'far fa-pen icon-pencil'
				),
				array(
						'linktype' => 'LISTVIEWRECORD',
						'linklabel' => 'LBL_DELETE',
						'linkurl' => "javascript:Settings_Vtiger_List_Js.triggerDelete(event,'".$this->getDeleteUrl()."');",
						'linkicon' => 'far fa-trash-alt icon-trash'
				)
		);
	...
	public function save() {
        ...
        // Modified by Hieu Nguyen on 2020-08-26 to save roundrobin users
		$roundrobinUsersList = $this->get('roundrobin_userid');
        // End Hieu Nguyen
