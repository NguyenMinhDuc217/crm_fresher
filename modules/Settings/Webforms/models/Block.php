                ...
                case 'LBL_ASSIGN_USERS' : 
                    $fieldsList = array(
                            ...
                            'roundrobin_userid' =>array(
                                    'uitype' => '53',   // Modified by Hieu Nguyen on 2020-08-25 to display this field as custom owner field                                                     
                                    'name' => 'roundrobin_userid',
                                    'label' => 'LBL_ROUNDROBIN_USERS_LIST',
                                    'typeofdata' => 'V~M',
                                    'diplaytype' => '1',
                                    'defaultvalue' => '',   // Modified by Hieu Nguyen on 2020-09-28 to fix issue round robin user value is 'NULL' when no user selected
                            )
                    );
                    break;
            }
