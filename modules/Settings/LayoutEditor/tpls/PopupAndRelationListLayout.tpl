...
{strip}
    ...
    {else}
        ...
        <link type="text/css" rel="stylesheet" href="{vresource_url('modules/Settings/LayoutEditor/resources/PopupAndRelationListEditor.css')}"></link>
        <script type="text/javascript" src="{vresource_url('modules/Settings/LayoutEditor/resources/PopupAndRelationListEditor.js')}"></script>
