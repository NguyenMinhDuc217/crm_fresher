...
class Settings_Vtiger_ConfigModule_Model extends Settings_Vtiger_Module_Model {
	...
	public function getEditableFields() {
		return array(
			...
			//-- Added By Kelvin Thang on 2020-01-07 config set max selection size minilist wizard in dashboard
			'minilist_widget_max_columns' => array('label' => 'LBL_MINILIST_WIDGET_MAX_COLUMNS',	'fieldType' => 'input')
		);
	}
