...
class Settings_Workflows_Edit_View extends Settings_Vtiger_Index_View {
	...
	public function process(Vtiger_Request $request) {
		$GLOBALS['current_view'] = 'detail';	// Added by Hieu Nguyen on 2021-09-30 to workarround load selected module fields by its DetailView layout
	...
	public function preProcess(Vtiger_Request $request) {
		...
		// Added by Hieu Nguyen on 2022-02-28 to check access to forbidden feature
		if (empty($recordId)) {
			checkAccessForbiddenFeature('CreateNewWorkflows');
		}
		// End Hieu Nguyen
