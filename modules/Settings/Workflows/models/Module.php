...
//	var $listFields = array('summary' => 'Summary', 'module_name' => 'Module', 'execution_condition' => 'Execution Condition');
	...
	// Modified by Hieu Nguyen on 2021-08-18 to hide forbidden module in this package and hidden module from Workflows
	public static function getSupportedModules() {
		...
		foreach ($moduleModels as $tabId => $moduleModel) {
			...
			if ($moduleModel->isWorkflowSupported() && $moduleName != 'Webmails') {
