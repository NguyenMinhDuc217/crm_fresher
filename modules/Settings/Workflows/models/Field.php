...
class Settings_Workflows_Field_Model extends Vtiger_Field_Model {
	...
	public static function getAdvancedFilterOpsByFieldType() {
		return array(
			...
			'personName' => array('is', 'is not', 'contains', 'does not contain', 'starts with', 'ends with', 'has changed', 'is empty', 'is not empty'),	// Added by Hieu Nguyen on 2021-09-30 to display filter options for person name
			...
			'multipicklist' => array('contains','does not contain', 'has changed', 'has changed to'),
