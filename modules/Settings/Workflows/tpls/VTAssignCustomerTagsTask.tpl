...
{strip}
		...
		<div class="col-lg-9">
			{if !Settings_Workflows_Util_Helper::isCustomerModule($SOURCE_MODULE)}
				<div class="row form-group variable">
					<div class="col-lg-3 fieldLabel">{vtranslate('LBL_ASSIGN_CUSTOMER_TAGS_TASK_RELATED_CUSTOMER_FIELD', $QUALIFIED_MODULE)}<span class="redColor">*</span></div>
			...
			{if Settings_Workflows_Util_Helper::isInventoryModule($SOURCE_MODULE)}
				<div class="row form-group variable">
					<div class="col-lg-3 fieldLabel">{vtranslate('LBL_ASSIGN_CUSTOMER_TAGS_TASK_GET_TAGS_FROM_PRODUCTS_AND_SERVICES', $QUALIFIED_MODULE)}<span class="redColor">*</span></div>
					<div class="col-lg-9 fieldValue">
			...
			<div class="row form-group variable">
				<div class="col-lg-3 fieldLabel">{vtranslate('LBL_ASSIGN_CUSTOMER_TAGS_TASK_TAG_LIST', $QUALIFIED_MODULE)}<span class="redColor">*</span></div>
				<div class="col-lg-9 fieldValue">
					...
					&nbsp;
					<button type="button" id="btn-new-tag"><i class="far fa-plus"></i></button>
				</div>
			</div>

			<div class="alert alert-danger">
				<b>{vtranslate('LBL_NOTE', $QUALIFIED_MODULE)}:</b>&nbsp;{vtranslate('LBL_ASSIGN_CUSTOMER_TAGS_TASK_TAGS_HINT', $QUALIFIED_MODULE)}
			</div>
			<hr/>
		</div>
	</div>

	{* Template for create/edit tag popover *}
	<div id="editTagContainer" class="hide">
		...
		<div class="editTagContents">
			<div>
				<input type="text" name="tag_name" class="form-control" value="" maxlength="50" style="width: 100%" />
			</div>
		</div>
	...
	<link type="text/css" rel="stylesheet" href="{vresource_url("modules/Settings/Workflows/resources/VTAssignCustomerTagsTask.css")}"></link>
	<script src="{vresource_url("modules/Settings/Workflows/resources/VTAssignCustomerTagsTask.js")}"></script>
{/strip}