...
class Campaigns_Relation_Model extends Vtiger_Relation_Model {
	...
	// Added by Hieu Nguyen on 2022-12-26
	public function isDeletable() {
		if (self::isAtRelatedList()) {
			$parentRecordModel = self::getParentRecordModelAtRelatedList();

			// Do not allow to unlink MKT List at Campaign detail
			if ($parentRecordModel->get('campaigntype') == 'Telesales' && $this->getRelationModuleName() == 'CPTargetList') {
				return false;
			}
		}
