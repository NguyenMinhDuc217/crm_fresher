...
class Calendar_Detail_View extends Vtiger_Detail_View {
	...
	// Added by Phu Vo on 2018.12.15
	function process(Vtiger_Request $request) {
		$record = $request->get('record');
		$recordModel = Vtiger_Record_Model::getInstanceById($record, 'Calendar');
		$pbxLogData = $recordModel->getPBXLogData();
		$viewer = $this->getViewer($request);
		$viewer->assign('PBX_LOG_DATA', $pbxLogData);
	...
	function showModuleDetailView(Vtiger_Request $request) {
        ...
        // Added by Hieu Nguyen on 2019-10-29 to load custom code for overlay detail view
		...
		if($moduleName=='Events') {
            ...
            // Commented out these lines by Hieu Nguyen on 2019-11-29 as they are not used anymore
