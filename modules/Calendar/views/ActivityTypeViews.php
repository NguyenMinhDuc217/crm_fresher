...
class Calendar_ActivityTypeViews_View extends Vtiger_Index_View {
	...
	public function addActivityType(Vtiger_Request $request) {
        ...
        // Modified by Hieu Nguyen on 2019-12-19 to call these functions from My Calendar Model
		$calendarViews = Calendar_MyCalendar_Model::getCalendarViewTypes($currentUser->id);
		$allViewTypes = Calendar_MyCalendar_Model::getCalendarViewTypesToAdd($currentUser->id);
		$allViewConditions = Calendar_MyCalendar_Model::getCalendarViewConditions();
        // End Hieu Nguyen
	...
	public function editActivityType(Vtiger_Request $request) {
        ...
        // Modified by Hieu Nguyen on 2019-12-19 to call these functions from My Calendar Model
		$calendarViews = Calendar_MyCalendar_Model::getCalendarViewTypes($currentUser->id);
		$visibleViewTypes = Calendar_MyCalendar_Model::getCalendarViewTypesForEdit($currentUser->id);
		$allViewConditions = Calendar_MyCalendar_Model::getCalendarViewConditions();
        // End Hieu Nguyen
