...
class Calendar_QuickCreateAjax_View extends Vtiger_QuickCreateAjax_View {
	...
	public function  process(Vtiger_Request $request) {
		...
		foreach($moduleList as $module) {
			...
			// Modified Hieu Nguyen 2022-01-18 to auto set related account when related contact is set
			$contactId = $request->get('contact_id');

			if (($request->get('parentModule') == 'Contacts' || $request->get('returnmodule') == 'Contacts') && $contactId) {
		...
		// Added by Hieu Nguyen on 2018-11-21 to load custom code
