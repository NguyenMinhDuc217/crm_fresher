...
class Calendar_Save_Action extends Vtiger_Save_Action {
	...
	protected function getRecordModelFromRequest(Vtiger_Request $request) {
		...
		// Modified by Phu Vo on 2021.07.12 to fix issue update date time field on accident
		if ($request->get('date_start', null) !== null) $recordModel->set('date_start', $startDate);
		if ($request->get('time_start', null) !== null) $recordModel->set('time_start', $startTime);
		// End Phu Vo
		...
		// Modified by Phu Vo on 2021.07.12 to fix issue update date time field on accident
		if ($request->get('time_end', null) !== null) $recordModel->set('time_end', $endTime);
		if ($request->get('due_date', null) !== null) $recordModel->set('due_date', $endDate);
		// End Phu Vo
