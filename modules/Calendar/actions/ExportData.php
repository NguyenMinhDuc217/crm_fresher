...
class Calendar_ExportData_Action extends Vtiger_ExportData_Action {
	...
	public function sanitizeValues($arr) {
		...
		// [Core][SOr2IHIo] Modified by Phu Vo on 2019.12.09 to map value with it headers
		unset($sanitizeValues['time_start']);
		unset($sanitizeValues['time_end']);
		// End Phu Vo
        ...
        // Commented out by Hieu Nguyen to replace the export logic for contacts field
        ...
        // Added by Hieu Nguyen on 2019-11-27 to export contact invitees
        $sanitizeValues['contact_id'] = Events_Invitation_Helper::getInvitedContactsForListView($activityId);
        // End Hieu Nguyen

        // Added by Hieu Nguyen on 2019-11-27 to export user invitees
        $sanitizeValues['user_invitees'] = Events_Invitation_Helper::getInvitedUsersForListView($activityId);
        // End Hieu Nguyen
	...
	public function getHeaders() {
		// Modified by Phu Vo on 2019.12.09 to correct array index
		$translatedHeaders = array_values(array_unique(parent::getHeaders()));
		// End Phu Vo
