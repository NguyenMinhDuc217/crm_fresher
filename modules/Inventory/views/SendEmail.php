...
class Inventory_SendEmail_View extends Vtiger_ComposeEmail_View {
	...
	public function composeMailData(Vtiger_Request $request) {
		...
		// Custom by Phuc on 2019.10.24 to change method to export pdf
		require_once('include/utils/InventoryPDFUtils.php');
		//$pdfFileName = $recordModel->getPDFFileName();
		$pdfFileName = InventoryPDFUtils::getPDFFileName($recordModel, 'F'); // Modified by Tung Nguyen on 2022.07.07
		// Ended by Phuc
