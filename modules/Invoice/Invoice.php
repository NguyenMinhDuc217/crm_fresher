...
class Invoice extends CRMEntity {
	...
	*/
	...
	function generateReportsSecQuery($module,$secmodule,$queryPlanner){
		...
		// Modified by Hieu Nguyen on 2021-09-13 to fix bug query error when select Invoice as secondary module and tick calculate total by Invoice amount
		if ($queryPlanner->requireTable('vtiger_inventoryproductrelInvoice', $matrix)) {
			$query .= " LEFT JOIN vtiger_inventoryproductrel AS vtiger_inventoryproductreltmpInvoice ON (vtiger_inventoryproductreltmpInvoice.id = vtiger_invoice.invoiceid)";
		}
		// End Hieu Nguyen
