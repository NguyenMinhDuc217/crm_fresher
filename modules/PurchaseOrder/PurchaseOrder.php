...
class PurchaseOrder extends CRMEntity {
	...
	function generateReportsSecQuery($module,$secmodule,$queryPlanner){
		...
		// Modified by Hieu Nguyen on 2021-09-13 to fix bug query error when select PO as secondary module and tick calculate total by PO amount
		if ($queryPlanner->requireTable('vtiger_inventoryproductrelPurchaseOrder', $matrix)) {
			$query .= " LEFT JOIN vtiger_inventoryproductrel AS vtiger_inventoryproductreltmpPurchaseOrder ON (vtiger_inventoryproductreltmpPurchaseOrder.id = vtiger_purchaseorder.purchaseorderid)";
		}
		// End Hieu Nguyen
