...
class PurchaseOrder_CompanyDetails_Action extends Vtiger_Action_Controller {
    ...
    function getCompanyDetails($request){
        ...
        // Modified by Hieu Nguyen on 2020-12-08 to display correct unicode string
        $companyDetails = [
            'street' => decodeUTF8($companyModel->get('organizationname')) .' '. decodeUTF8($companyModel->get('address')),
            'city' => decodeUTF8($companyModel->get('city')),
            'state' => decodeUTF8($companyModel->get('state')),
            'code' => decodeUTF8($companyModel->get('code')),
            'country' =>  decodeUTF8($companyModel->get('country')),
        ];
        // End Hieu Nguyen
