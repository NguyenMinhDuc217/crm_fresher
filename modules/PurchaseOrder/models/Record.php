...
class PurchaseOrder_Record_Model extends Inventory_Record_Model {
	 ...
	 * Function to get List of Fields which are related from PurchaseOrder to Inventory Record.
	 * @return [['parentField' => 'purchaseorder_fieldname', 'inventoryField' => 'current_inventorymodule_filename'], 'defaultValue' => '']
	 */
