...
class Products extends CRMEntity {
	...
	*/
	function insertTaxInformation($tablename, $module)
	{
		...
		// Added by Vu Mai on 2023-01-13 to support case uncheck tax_check field when quick edit product
		if ($_REQUEST['action'] === 'MassEditSave') {
			$adb->pquery('DELETE FROM vtiger_producttaxrel WHERE productid = ?', array($this->id));
		}
		// End Vu Mai
