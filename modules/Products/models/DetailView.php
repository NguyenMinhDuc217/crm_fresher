...
class Products_DetailView_Model extends Vtiger_DetailView_Model {
	...
	// Added by Hieu Nguyen on 2022-09-05 to customize the display of detailview subpanels
	public function getDetailViewRelatedLinks() {
		$relatedLink = parent::getDetailViewRelatedLinks();

		for ($i = 0; $i < count($relatedLink); $i++) {
			if (isForbiddenFeature('ProductBundle') && in_array($relatedLink[$i]['linklabel'], ['Product Bundles', 'Parent Product'])) {
				$relatedLink[$i] = null;
			}
		}
