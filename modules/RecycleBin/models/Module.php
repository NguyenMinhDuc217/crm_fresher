...
class RecycleBin_Module_Model extends Vtiger_Module_Model {
	 ...
	 * @return <array>
	 */
	// Modified by Hieu Nguyen on 2022-09-15 to hide hidden modules and forbidden module from Recycle Bin sidebar
	public function getAllModuleList() {
		...
		$restrictedModules = array_merge($restrictedModules, $hiddenModules, getForbiddenFeatures('module'));
