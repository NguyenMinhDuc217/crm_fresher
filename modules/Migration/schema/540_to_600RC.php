...
$adb = PearDatabase::getInstance();
$user = new Users();
$current_user = $user->retrieveCurrentUserInfoFromFile(Users::getRootAdminId());
...
// Restore the UserId
$current_user->id = Users::getRootAdminId();
...
do {
	...
	for($i=0; $i<$rows; $i++) {
		...
		$modComments->column_fields['assigned_user_id'] = $modComments->column_fields['creator'] = Users::getRootAdminId();
...
$module = 'Users';
$user = new $module();
$activeAdmin = Users::getRootAdminId();
