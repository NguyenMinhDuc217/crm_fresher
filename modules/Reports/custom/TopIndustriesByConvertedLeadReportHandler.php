...
/*
    TopIndustriesByConvertedLeadReportHandler.php
    Author: Phuc Lu
    Date: 2020.08.12
*/
...
class TopIndustriesByConvertedLeadReportHandler extends TopSourcesByLeadReportHandler {
    protected $targetModule = 'INDUSTRY_CONVERTED_LEAD';
    ...
    protected function getChartData(array $params) {
        ...
        foreach ($reportData as $row) {
            $data[] = [vtranslate($row['industry']), (float)$row['converted_lead_number']];
            $links[] = '';
        }        
    ...
    protected function getReportData($params, $forExport = false) {
        ...
        // Data for sales
        $sql = "SELECT 0 AS no, industry, COUNT(leadid) AS lead_number, SUM(IF(converted = 1, 1, 0)) AS converted_lead_number
            ...
            ORDER BY converted_lead_number DESC
            LIMIT 5";
