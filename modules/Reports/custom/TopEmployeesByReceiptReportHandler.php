...
/*
    TopEmployeesByReceiptReportHandler.php
    Author: Phuc Lu
    Date: 2020.08.11
*/
...
class TopEmployeesByReceiptReportHandler extends TopSourcesByLeadReportHandler {
    ...
    protected function getReportData($params, $forExport = false) {
        ...
        $sql = "SELECT 0 AS no, id, {$fullNameField} AS user_full_name, COUNT(cpreceiptid) AS receipt_number, SUM(amount_vnd) AS receipt_amount
            ...
            WHERE expiry_date BETWEEN '{$period['from_date']}' AND '{$period['to_date']}'
