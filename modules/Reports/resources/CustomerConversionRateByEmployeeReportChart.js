/*
    CustomerConversionRateByEmployeeReportChart.js
    Author: Phuc Lu
    Date: 2020.05.12
*/

window.CustomerConversionRateByEmployeeReportChart = class extends CustomChartWidget {
    ...
    drawChart (placeholderId, width, height) {
        ...
        var options = {
            ...
            series: {
                ...
                1: { type: "line", targetAxisIndex: 1, color: '#f7a35c' }
            },
        };
        ...
        var runOnce = google.visualization.events.addListener(chart, 'ready', function () {
            ...
            for (var i = 0; i < 6; i++) {
                ...
                newRightTicks.push({ v: rightInterval * i, f: rightVal[0] + '%'});
            }
