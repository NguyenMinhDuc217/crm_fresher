/*
    SalesByProductGroupReportChart.js
    Author: Phuc Lu
    Date: 2020.06.25
*/

window.SalesByProductGroupReportChart = class extends CustomChartWidget {
    drawChart (placeholderId, width, height) {
        ...
        var runOnce = google.visualization.events.addListener(chart, 'ready', function () {
            ...
            for (var i = 0; i < 6; i++) {
                ...
                if (rightInterval < 1 && i == 3) {
                    rightVal = _this.getFormatedValueAndSuffix(rightInterval * 10 * i / 10);
                }
                else {
