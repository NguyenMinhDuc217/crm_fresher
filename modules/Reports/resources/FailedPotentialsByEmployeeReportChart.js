/*
    FailedPotentialsByEmployeeReportChart.js
    Author: Phuc Lu
    Date: 2020.05.18
*/

window.FailedPotentialsByEmployeeReportChart = class extends CustomChartWidget {
    ...
    drawChart (placeholderId, width, height) {
        ...
        var options = {
            ...
            chartArea: { left: '7%', top: '7%', width: '86%', height: '70%' }, 
            vAxes: {
                0: {
