/*
    PotentialConversionRateReportChart.js
    Author: Phuc Lu
    Date: 2020.08.18
*/

window.PotentialConversionRateReportChart = class extends CustomChartWidget {
        ...
        Highcharts.chart(placeholderId, {
            ...
            tooltip: {
                pointFormatter: function() {
                    var point = this;
                    return '<span>' + point.series.name + ': <b>' + (app.formatNumberToUserFromNumber(100 * point.y / firstValue)) + '% (' + point.y + '/' + firstValue + ')</b><br/>';
                }
            },
            responsive: {
                rules: [
