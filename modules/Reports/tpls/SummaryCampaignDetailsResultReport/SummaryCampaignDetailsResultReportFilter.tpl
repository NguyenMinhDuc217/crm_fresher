{*
    SummaryCampaignDetailsResultReportFilter.tpl
    Author: Phu Vo
    Date: 2020.08.19
*}
    ...
    <form id="form-filter" name="filter" action="" method="GET" class="filter-container recordEditView">
        ...
        <div class="filter-group">
            ...
            <div class="control-label col-sm-8">
                <select name="campaigns[]" multiple id="campaigns" class="filter dislayed-filter width-340">
                    {html_options options=$FILTER_META.all_campaigns selected=$PARAMS.campaigns}
                </select>
            </div>
        </div>
        <div class="filter-group">
