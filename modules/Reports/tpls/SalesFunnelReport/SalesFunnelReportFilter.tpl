...
{strip}
    ...
    <form id="form-filter" name="filter" action="" method="GET" class="filter-container recordEditView">
        ...
        <div class="filter-group">
            ...
            <div class="control-label col-sm-8">
                <select name="displayed_by" id="displayed_by" class="filter dislayed-filter width-340">
                    {html_options options=$FILTER_META.displayed_by_options selected=$PARAMS.displayed_by}
                </select>
            </div>
        </div>
        ...
        <div class="filter-group">
            ...
            <div class="control-label col-sm-8">
                <select name="employee" id="employee" data-reference="deparments" data-rule-required="true" class="filter dislayed-filter select2 width-340">
        ...
        <div class="filter-group">
            <div class="control-label fieldLabel col-sm-4">
                {vtranslate('LBL_REPORT_CHOOSE_CAMPAIGN', 'Reports')}:
            </div>
            <div class="control-label col-sm-8">
                <select name="campaign" id="campaign" class="filter dislayed-filter width-340">
                    {html_options options=$FILTER_META.all_campaigns selected=$PARAMS.campaign}
                </select>
            </div>
        </div>
