{*
    TopEmployeesByPotentialSalesReportFilter.tpl
    Author: Phu Vo
    Date: 2020.08.19
*}
                ...
                <div class="time-group">
                    ...
                    <div class="group-field-wraper period">
                        ...
                        <div class="input-group date-time-field hide">
                            <input name="from_date" id="from-date" type="text" class="dateField form-control dislayed-time" data-fieldtype="date" value="{if isset($PARAMS['from_date'])}{$PARAMS['from_date']}{/if}" placeholder=""><span class="input-group-addon"><i class="far fa-calendar "></i></span>
                        </div>

                        <span class="date-time-field hide">{vtranslate('LBL_REPORT_TO', 'Reports')}&nbsp;</span>
                        <div class="input-group date-time-field hide">
                            <input name="to_date" id="to-date" data-specific-rules={literal}'[{"name":"greaterThanDependentField","params":["from_date"]}]'{/literal} type="text" class="dateField form-control dislayed-time" data-fieldtype="date"  value="{if isset($PARAMS['to_date'])}{$PARAMS['to_date']}{/if}" placeholder=""><span class="input-group-addon"><i class="far fa-calendar "></i></span>
                        </div>
                    </div>
                </div>
            </div>
