{*
    StatisticCustomerBuyProductsReportFilter.tpl
    Author: Phu Vo
    Date: 2020.08.19
*}
    ...
    <form id="form-filter" name="filter" action="" method="GET" class="filter-container recordEditView">
        ...
        <div class="filter-group">
            <div class="control-label fieldLabel col-sm-4">
                {vtranslate('LBL_REPORT_CHOOSE_BOUGHT_PRODUCTS', 'Reports')}:
            </div>
            <div class="control-label col-sm-8">
                <select name="bought_products[]" id="bought_products" data-rule-required = "true" multiple class="filter select2 dislayed-filter width-340">
                    {html_options options=$FILTER_META.products selected=$PARAMS.bought_products}
                </select>
            </div>
        </div>
        ...
        <div class="filter-group">
            <div class="control-label fieldLabel col-sm-4">
                {vtranslate('LBL_REPORT_CHOOSE_NO_BOUGHT_PRODUCTS', 'Reports')}:
            </div>
            <div class="control-label col-sm-8">
                <select name="no_bought_products[]" id="no_bought_products" multiple class="filter select2 dislayed-filter width-340">
                    {html_options options=$FILTER_META.products selected=$PARAMS.no_bought_products}
                </select>
            </div>
        </div>
