{* Moved Report Filter into seperated template file by Hieu Nguyen on 2020-09-07 so that it can be loaded from Embedded Report Chart *}
    ...
    <div class="filter-group">
        ...
        <div class="control-label col-sm-8">
            <div class="time-group">    
                ...
                {* BEGIN-- Modified by Phu Vo on 2020.09.15 to support group input *}
                ...
                {* END-- Modified by Phu Vo on 2020.09.15 to support group input *}
