                    ...
                    <tbody>
                        {foreach from=$REPORT_DATA item=ROW key=NO name=INDEX}
                            <tr {if $smarty.foreach.INDEX.last} style="font-weight: bold !important;"{/if}>
                                ...
                                {if $ROW.id != 'all'}
                                    <td class="text-left">
                                        {if $REPORT_OBJECT == 'EMPLOYEE'}
                                            <a target="_blank" onclick="window.open('index.php?module=Users&view=PreferenceDetail&parent=Settings&record={$ROW.id}')">{$ROW.full_name}</a>
                                        {else}
                                            {$ROW.full_name}
                                        {/if}
                                    </td>
                                ...
                                <td class="text-right">
                                    {formatNumberToUser($ROW.tickets)}
                                </td>
                            </tr>
                        {foreachelse}
                            <tr>
