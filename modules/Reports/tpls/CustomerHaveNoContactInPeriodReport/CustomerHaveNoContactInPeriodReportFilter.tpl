{*
    CustomerHaveNoContactInPeriodReportFilter.tpl
    Author: Phu Vo
    Date: 2020.08.19
*}
    ...
    <form id="form-filter" name="filter" action="" method="GET" class="filter-container recordEditView">
        ...
        <div class="filter-group">
            ...
            <div class="control-label col-sm-8">
                <input type="text" name="period_days" data-rule-required="true" onkeyup="formatNumber(this, 'int')" class="inputElement dislayed-filter text-right" value="{$PARAMS.period_days}"/> {vtranslate('LBL_REPORT_DAY', 'Reports')|lower} {vtranslate('LBL_REPORT_HAVE_NO_CONTACTED', 'Reports')|lower}
            </div>
        </div>
