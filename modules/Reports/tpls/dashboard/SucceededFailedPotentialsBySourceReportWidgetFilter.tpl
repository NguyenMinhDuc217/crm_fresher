...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="controls fieldValue col-sm-7">    
            {assign var="SOURCES" value=Reports_CustomReport_Helper::getSourceValues(true, false, false)}
            <select name="filter[source]" id="source"  data-rule-required="true" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
