...
{strip}
    ...
    <div class="form-group">
        ...
        <label class="control-label fieldLabel col-sm-5">
            <strong>{vtranslate('LBL_REPORT_INDUSTRY', 'Reports')}:</strong>
        </label>
        <div class="controls fieldValue col-sm-7">    
            {assign var="INDUSTRIES" value=Reports_CustomReport_Helper::getIndustryValues(false, true, true)}
            <select name="filter[industries][]" multiple  data-rule-required="true" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
