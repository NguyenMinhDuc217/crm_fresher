{*
    SourceSalesByProvinceReportWidgetFilter.tpl
    Author: Phuc Lu
    Date: 2020.06.16
*}
...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="controls fieldValue col-sm-7">    
            ...
            <select name="filter[source]" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
        ...
        <div class="controls fieldValue col-sm-7">    
            {assign var="PROVINCES" value=Reports_CustomReport_Helper::getProvinceValues(false, true, true, 'Contacts')}
