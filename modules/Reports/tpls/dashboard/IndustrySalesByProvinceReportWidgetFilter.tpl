{*
    IndustrySalesByProvinceReportWidgetFilter.tpl
    Author: Phuc Lu
    Date: 2020.06.16
*}
...
{strip}
    ...
    <div class="form-group">
        ...
        <label class="control-label fieldLabel col-sm-5 ">
            <strong>{vtranslate('LBL_REPORT_CHOOSE_INDUSTRY', 'Reports')}</strong>
        </label>
        <div class="controls fieldValue col-sm-7">    
            {assign var="INDUSTRIES" value=Reports_CustomReport_Helper::getIndustryValues(true, false, true)}
            <select name="filter[industry]" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
        ...
        <label class="control-label fieldLabel col-sm-5">
            <strong> {vtranslate('LBL_REPORT_CHOOSE_PROVINCE', 'Reports')}:</strong>
        </label>
        <div class="controls fieldValue col-sm-7">    
            {assign var="PROVINCES" value=Reports_CustomReport_Helper::getProvinceValues(false, true, true)}
            <select name="filter[provinces][]" id="provinces" multiple data-rule-required="true" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
