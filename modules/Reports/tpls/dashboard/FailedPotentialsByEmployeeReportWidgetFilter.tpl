{*
    CustomerConversionRateByEmployeeReportWidgetFilter.tpl
    Author: Phuc Lu
    Date: 2020.05.12
*}
...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="controls fieldValue col-sm-7">    
            ...
            <select name="filter[departments][]" multiple class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
        ...
        <div class="controls fieldValue col-sm-7">    
            {assign var="USERS" value=Reports_CustomReport_Helper::getUsersByDepartment($PARAMS.department, false, true)}
            <select name="filter[employees][]" multiple class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
                {html_options options=$USERS selected=$PARAMS.employees}
            </select>
        </div>
        <div style="clear: both;"></div>
