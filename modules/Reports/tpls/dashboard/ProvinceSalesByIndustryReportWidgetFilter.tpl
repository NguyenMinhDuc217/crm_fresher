{*
    ProvinceSalesByIndustryReportWidgetFilter.tpl
    Author: Phuc Lu
    Date: 2020.06.16
*}
...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="controls fieldValue col-sm-7">    
            {assign var="INDUSTRIES" value=Reports_CustomReport_Helper::getIndustryValues(false, true, true)}
            <select name="filter[industries][]" multiple class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
                {html_options options=$INDUSTRIES selected=$PARAMS.industries}
            </select>
        </div>
    </div>
{/strip}