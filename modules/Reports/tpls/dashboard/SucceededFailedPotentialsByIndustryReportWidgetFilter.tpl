...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="controls fieldValue col-sm-7">    
            {assign var="INDUSTRIES" value=Reports_CustomReport_Helper::getIndustryValues(true, false, false)}
            <select name="filter[industry]" id="industry"  data-rule-required="true" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
