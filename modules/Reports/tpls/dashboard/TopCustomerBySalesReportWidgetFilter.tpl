...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="controls fieldValue col-sm-7">
             <select name="filter[target]" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
        ...
        <div class="controls fieldValue col-sm-7">
             <select name="filter[top]" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
                <option value="10" {if $PARAMS.top == '10'}selected{/if}>{vtranslate('LBL_REPORT_TOP', 'Reports')} 10</option>
                <option value="5" {if $PARAMS.top == '5'}selected{/if}>{vtranslate('LBL_REPORT_TOP', 'Reports')} 5</option>
            </select>
        </div>
    </div>
{/strip}