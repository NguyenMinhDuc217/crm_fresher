{*
    AnalyzeSalesDataReportWidgetFilter.tpl
    Author: Phuc Lu
    Date: 2020.06.03
*}
...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="controls fieldValue col-sm-7">
            {assign var="DISPLAYED_BY_OPTIONS" value=Reports_CustomReport_Helper::getDisplayedByForAnalyzeReport()}
            <select name="filter[displayed_by]" class="inputElement select2 select2-offscreen form-control widgetFilter reloadOnChange">
