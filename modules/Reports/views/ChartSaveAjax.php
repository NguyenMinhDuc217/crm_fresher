...
class Reports_ChartSaveAjax_View extends Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
        ...
        // Modified by Hieu Nguyen on 2020-04-09 to save chart report filter only when user hit the save button
        if ($mode == 'save') {
            $reportModel->save();
        }
        // End Hieu Nguyen
        ...
        // Added by Hieu Nguyen on 2021-06-03 render chart for chart report using HighCharts library
