...
class VTScheduledReport extends Reports {
	...
	public function sendEmail() {
		...
		// Added by Phuc on 2019.11.15 to get system email and name
		$systemEmailAddress = getSystemEmailAddress();
		$fromName = $systemEmailAddress['name'];
		$fromEmail = $systemEmailAddress['email'];
