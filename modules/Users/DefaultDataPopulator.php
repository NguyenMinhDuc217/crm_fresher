...
class DefaultDataPopulator extends CRMEntity {
	...
	function create_tables() {
		...
		$this->db->query("insert into vtiger_field values (14," . $this->db->getUniqueID("vtiger_field") . ",'active','vtiger_products',1,'56','active','Product Active',1,2,'',100,3,31,1,'V~O',2,2,'BAS',1)");
