...
class Users_ListView_Model extends Vtiger_ListView_Model {
    ...
    public function getQuery() {
            ...
            $listQuery .= " AND vtiger_users.deleted < 2 AND vtiger_users.user_name != 'admin'";    // Modified by Hieu Nguyen on 2021-07-13 to load only users have not been deleted permanently
            return $listQuery;
    }
