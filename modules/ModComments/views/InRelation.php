...
class ModComments_InRelation_View extends Vtiger_RelatedList_View {
	...
	function process(Vtiger_Request $request) {
		...
		// Modified by Hieu Nguyen on 2022-09-12 to fix attachment does not save with comment in Comments subpanel
		$relatedListContent = $viewer->view('ShowAllComments.tpl', $moduleName, 'true');
		return '<form id="comments-form">'. $relatedListContent .'</form>';
		// End Hieu Nguyen
	}
