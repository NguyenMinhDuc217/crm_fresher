...
class ModCommentsCore extends CRMEntity {
	...
	function generateReportsSecQuery($module,$secmodule,$queryplanner){
        ...
        $query .= parent::getReportsUiType10Query($secmodule, $queryplanner);	// Modified by Hieu Nguyen on 2022-10-18 to fix bug $queryPlanner is null when passing to this function
