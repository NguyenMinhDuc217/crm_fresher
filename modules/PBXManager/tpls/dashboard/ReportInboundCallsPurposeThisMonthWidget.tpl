{*
    ReportInboundCallsPurposeThisMonthWidget.tpl
    Author: Hieu Nguyen
    Date: 2020-02-18
*}
...
{strip}
    <script type="text/javascript">
        Vtiger_Custom_Widget_Js('PBXManager_ReportInboundCallsPurposeThisMonth_Widget_Js', {}, {});
    </script>
    ...
    <div class="dashboardWidgetContent report-inbound-calls-purpose-this-month-widget">
        {$WIDGET_CONTENT}
    </div>
