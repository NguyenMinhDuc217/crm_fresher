{*
    ReportOutboundCallsPurposeTodayWidget.tpl
    Author: Hieu Nguyen
    Date: 2019-10-25
*}
...
{strip}
    <script type="text/javascript">
        Vtiger_Custom_Widget_Js('PBXManager_ReportOutboundCallsPurposeToday_Widget_Js', {}, {});
    </script>
    ...
    <div class="dashboardWidgetContent report-outbound-calls-purpose-today-widget">
        {$WIDGET_CONTENT}
    </div>
