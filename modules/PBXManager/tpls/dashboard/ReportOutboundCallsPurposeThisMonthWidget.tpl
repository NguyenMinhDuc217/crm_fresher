{*
    ReportOutboundCallsPurposeThisMonthWidget.tpl
    Author: Hieu Nguyen
    Date: 2019-10-25
*}
...
{strip}
    <script type="text/javascript">
        Vtiger_Custom_Widget_Js('PBXManager_ReportOutboundCallsPurposeThisMonth_Widget_Js', {}, {});
    </script>
    ...
    <div class="dashboardWidgetContent report-outbound-calls-purpose-this-month-widget">
        {$WIDGET_CONTENT}
    </div>
