{*
    ReportInboundCallsPurposeTodayWidget.tpl
    Author: Hieu Nguyen
    Date: 2020-02-18
*}
...
{strip}
    <script type="text/javascript">
        Vtiger_Custom_Widget_Js('PBXManager_ReportInboundCallsPurposeToday_Widget_Js', {}, {});
    </script>
    ...
    <div class="dashboardWidgetContent report-inbound-calls-purpose-today-widget">
        {$WIDGET_CONTENT}
    </div>
