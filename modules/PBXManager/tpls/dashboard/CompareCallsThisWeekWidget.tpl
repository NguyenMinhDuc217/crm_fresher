{*
    CompareCallsThisWeekWidget.tpl
    Author: Hieu Nguyen
    Date: 2019-10-26
*}
...
{strip}
    <script type="text/javascript">
        Vtiger_Custom_Widget_Js('PBXManager_CompareCallsThisWeek_Widget_Js', {}, {});
    </script>
    ...
    <div class="dashboardWidgetContent compare-calls-this-week-widget">
        {$WIDGET_CONTENT}
    </div>
