{*
    CompareCallsThisMonthWidget.tpl
    Author: Hieu Nguyen
    Date: 2019-10-26
*}
...
{strip}
    <script type="text/javascript">
        Vtiger_Custom_Widget_Js('PBXManager_CompareCallsThisMonth_Widget_Js', {}, {});
    </script>
    ...
    <div class="dashboardWidgetContent compare-calls-this-month-widget">
        {$WIDGET_CONTENT}
    </div>
