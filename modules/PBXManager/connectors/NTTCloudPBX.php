...
/*
    NTTCloudPBX_Connector
    Author: Hieu Nguyen
    Date: 2021-02-24
    Purpose: to handle communication with NTTCloudPBX Call Center
*/

require_once('modules/PBXManager/BaseConnector.php');
require_once('include/utils/CallCenterUtils.php');

class PBXManager_NTTCloudPBX_Connector extends PBXManager_Base_Connector {
    ...
    function makeCall($receiverNumber, $parentId) {
        ...
        $params = [
            ...
            'hotline' => PBXManager_Logic_Helper::getOutboundHotline()
        ];
        ...
        CallCenterUtils::saveDebugLog('[NTTCloudPBX] Make call request: '. $serviceUrl, null, $params, $response);
