...
/*
    ...
    Author: Loc Huynh
    Date: 2023-03-08
    Purpose: to handle communication with CloudCALL Call Center
*/

require_once('modules/PBXManager/BaseConnector.php');
require_once('include/utils/CallCenterUtils.php');

class PBXManager_CloudCALL_Connector extends PBXManager_Base_Connector {
    ...
    function makeCall($receiverNumber, $parentId) {
        ...
        CallCenterUtils::saveDebugLog('[CloudCALL] Make call request: '. $serviceUrl, null, $params, $response);
    ...
    function getAccessToken() {
		...
		// CloudCALL - Added by Loc Huynh
		$serviceUrl = str_replace("v1", "v3", $serviceUrl);
		// End Loc Huynh
