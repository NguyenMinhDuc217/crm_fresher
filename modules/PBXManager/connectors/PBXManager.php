...
class PBXManager_PBXManager_Connector {
    ...
    private static $SETTINGS_REQUIRED_PARAMETERS = array('webappurl' => 'text','outboundcontext' => 'text', 'outboundtrunk' => 'text' , 'vtigersecretkey' => 'password');      // Modified by Hieu Nguyen on 2020-01-09 to secure the secret key field
    ...
    const SETTING_MODULE_NAME = 'Settings:PBXManager'; // Added by Hieu Nguyen on 2018-10-05
    ...
    public function getSettingInfoMsg() {
        return vtranslate('LBL_PBXMANAGER_INFO', self::SETTING_MODULE_NAME);
    }

    // Implemented by Hieu Nguyen on 2018-10-05
    public function getSettingHelpText() {
        return vtranslate('LBL_INFO_WEBAPP_URL', self::SETTING_MODULE_NAME) .'<br><br>'. 
            vtranslate('LBL_FORMAT_WEBAPP_URL', self::SETTING_MODULE_NAME) .': '. 
            vtranslate('LBL_FORMAT_INFO_WEBAPP_URL', self::SETTING_MODULE_NAME);
    }
    ...
    public function handleStartupCall($details, $userInfo, $customerInfo) {
        ...
        $current_user = $user->getRootAdminUser();
