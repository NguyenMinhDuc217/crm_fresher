                    ...
                    <b-tabs class="mt-2">
                        <b-tab title="{vtranslate('LBL_ADD_NEW', $MODULE)}">
                            <b-form id="customer">
                                ...
                                <b-form-row>
                                    <b-col cols="3" sm="2">
                                        <label class="mt-3"><strong>{vtranslate('Lead Source', 'Contacts')}:<span v-show="isRequired(form_data.customer_type, 'leadsource')" class="text-danger"> *</span></strong></label>
                                    </b-col>
                                    <b-col cols="9" sm="4">
                                        <b-select :data-rule-required="isRequired(form_data.customer_type, 'leadsource')" name="leadsource" :options="meta_data.Contacts.picklist_fields.leadsource" v-model="form_data.leadsource" class="mt-2"></b-select>
                                    </b-col>
                                    <b-col cols="3" sm="2">
