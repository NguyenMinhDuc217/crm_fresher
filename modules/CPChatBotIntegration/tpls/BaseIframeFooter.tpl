...
*}
        ...
        {if file_exists("modules/CPChatBotIntegration/resources/{$VIEW}.js")}
            <script type="text/javascript" src="{vresource_url("modules/CPChatBotIntegration/resources/{$VIEW}.js")}"></script>
        {/if}
    </body>
</html>