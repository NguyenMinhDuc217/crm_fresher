...
class SMSNotifierBase extends CRMEntity {
    ...
    var $isReadonly = true; // Added by Hieu Nguyen on 2020-11-09 to make this module readonly
	...
	function __construct() {
		...
		$this->db = PearDatabase::getInstance(); // Modified by Phu Vo on 2019.10.24 to default use singleton
		$this->log = $log;
	}
