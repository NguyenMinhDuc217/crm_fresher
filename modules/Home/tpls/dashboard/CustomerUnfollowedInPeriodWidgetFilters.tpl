        ...
        <div class="row" style="margin-bottom: 6px">
            <div class="col-sm-12">
                ...
                <div class="col-lg-8 fieldValue">
                    <input type="text" class="widgetFilter inputElement reloadOnChange" name="period_days" onkeyup="formatNumber(this, 'int')" value="{$PARAMS.period_days}" style="width: 60px;" />&nbsp;&nbsp;
                    <span>{vtranslate('LBL_REPORT_DAY', 'Reports')|lower} {vtranslate('LBL_REPORT_HAVE_NO_CONTACTED', 'Reports')|lower}</span>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-lg-8 fieldValue">
                    <select name="target" class="widgetFilter dislayed-filter select2 reloadOnChange">
