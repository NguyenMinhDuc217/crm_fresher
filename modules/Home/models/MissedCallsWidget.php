...
class home_MissedCallsWidget_Model extends Home_BaseListCustomDashboard_Model {
    ...
    function getWidgetData($params) {
        ...
        $sql = "SELECT
            ...
            WHERE
                ...
                AND vtiger_activity.missed_call = 1 {$aclQuery}
            ORDER BY CONCAT(vtiger_activity.due_date, ' ', vtiger_activity.time_end) DESC";
