...
/**
 * CustomerHaveGuaranteeContractWillBeExpiredWidget
 * Author: Phu Vo
 * Date: 2020.08.26
 */

class Home_CustomerHaveGuaranteeContractWillBeExpiredWidget_Model extends Home_BaseListCustomDashboard_Model {
    ...
    function getWidgetData($params) {
        ...
        $sql = "SELECT
            ...
            WHERE
                vtiger_servicecontracts.servicecontracts_type = 'other'
