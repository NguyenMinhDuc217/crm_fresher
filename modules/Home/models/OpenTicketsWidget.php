...
/**
 * Name: OpenTicketsWidget.php
 * Author: Phu Vo
 * Date: 2020.08.27
 */

class Home_OpenTicketsWidget_Model extends Home_BaseListCustomDashboard_Model {
    ...
    function getWidgetHeaders($params) {
        $widgetHeaders = [
            ...
            [
                'name' => 'ticketstatus',
                'label' => vtranslate('Status', 'HelpDesk'),
            ],
            [
    ...
    function getWidgetData($params) {
        ...
        $sql = "SELECT
                ...
                vtiger_troubletickets.status AS ticketstatus,
            ...
            WHERE
                ...
                AND vtiger_troubletickets.status IN ('Open', 'Reopen') {$aclQuery}
        ...
        while ($row = $adb->fetchByAssoc($result)) {
            ...
            $row['ticketcategories'] = $this->getFieldDisplayValue($row['ticketcategories'], 'ticketpriorities', 'HelpDesk');
            $data[] = $row;
        }
