...
class home_InProgressTasksWidget_Model extends Home_BaseListCustomDashboard_Model {
    ...
    public function getWidgetData($params) {
        ...
        $sql = "SELECT
                ...
                vtiger_activity.due_date AS due_date
            ...
            WHERE
                ...
                AND vtiger_activity.status = 'In Progress'
                AND vtiger_activity.due_date >= DATE(NOW()) {$aclQuery}
        ...
        while ($row = $adb->fetchByAssoc($result)) {
            ...
            $row['due_date'] = $this->getFieldDisplayValue($row['due_date'], 'due_date', 'Calendar');
            $row['taskpriority'] = $this->getFieldDisplayValue($row['taskpriority'], 'taskpriority', 'Calendar');
