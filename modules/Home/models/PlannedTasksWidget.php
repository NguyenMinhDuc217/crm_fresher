...
class home_PlannedTasksWidget_Model extends Home_BaseListCustomDashboard_Model {
    ...
    function getWidgetData($params) {
        ...
        $sql = "SELECT
            ...
            WHERE
                ...
                AND vtiger_activity.status = 'Planned'
        ...
        while ($row = $adb->fetchByAssoc($result)) {
            ...
            $endDateTimeField = new DateTimeField($row['time_end']);
            $row['time_start'] = $dateTimeUIType->getDisplayValue($row['time_start']);
            $row['time_end'] = $endDateTimeField->getDisplayDate();
