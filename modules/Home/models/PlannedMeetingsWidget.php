...
/**
 * PlannedMeetingsWidget
 * Author: Phu Vo
 * Date: 2020.08.27
 */

class home_PlannedMeetingsWidget_Model extends Home_BaseListCustomDashboard_Model {
    ...
    function getWidgetData($params) {
        ...
        $sql = "SELECT
            ...
            FROM vtiger_activity INNER JOIN vtiger_crmentity ON (vtiger_crmentity.crmid = vtiger_activity.activityid AND vtiger_crmentity.setype = 'Calendar' AND vtiger_crmentity.deleted = 0) 
            WHERE
