...
/**
 * Name: ClosedTicketsWidget.php
 * Author: Phu Vo
 * Date: 2020.08.27
 */

class Home_ClosedTicketsWidget_Model extends Home_BaseListCustomDashboard_Model {
    ...
    function getWidgetData($params) {
        ...
        $sql = "SELECT
            ...
            WHERE
                ...
                AND vtiger_troubletickets.status = 'Closed' {$aclQuery}
