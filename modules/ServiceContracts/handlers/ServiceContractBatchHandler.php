...
/*
*	ServiceContractsBatchHandler.php
*	Author: Phuc Lu
*	Date: 2020.03.05
*   Purpose: provide batch handler function for module ServiceContractBatchHandler
*/

class ServiceContractBatchHandler extends VTEventHandler {

	function handleEvent($eventName, $entityDataList) {
		if ($entityDataList[0]->getModuleName() != 'ServiceContracts') return;
