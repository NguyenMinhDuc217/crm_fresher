...
class Quotes extends CRMEntity {
	...
	function generateReportsSecQuery($module,$secmodule,$queryPlanner){
		...
		// Modified by Hieu Nguyen on 2021-09-13 to fix bug query error when select Quote as secondary module and tick calculate total by Quote amount
		if ($queryPlanner->requireTable('vtiger_inventoryproductrelQuotes',$matrix)) {
			$query .= " LEFT JOIN vtiger_inventoryproductrel AS vtiger_inventoryproductreltmpQuotes ON (vtiger_inventoryproductreltmpQuotes.id = vtiger_quotes.quoteid)";
		}
		// End Hieu Nguyen
