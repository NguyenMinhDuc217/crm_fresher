...
class ModTracker_Field_Model extends Vtiger_Record_Model {
	...
	public function getDisplayValue($value) {
		// [CustomOwnerField] Added by Phu Vo on 2019.07.23 to process assigned user id display logic
		$rawValueFields = ['assigned_user_id'];

		if (in_array($this->getFieldInstance()->getName(), $rawValueFields)) {
			return $value;
		}
		// End process assigned user id display logic
