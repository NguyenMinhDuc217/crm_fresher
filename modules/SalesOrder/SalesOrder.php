...
class SalesOrder extends CRMEntity {
	...
	function generateReportsSecQuery($module,$secmodule,$queryPlanner){
		...
		// Modified by Hieu Nguyen on 2021-09-13 to fix bug query error when select SO as secondary module and tick calculate total by SO amount
		if ($queryPlanner->requireTable('vtiger_inventoryproductrelSalesOrder', $matrix)) {
			$query .= " LEFT JOIN vtiger_inventoryproductrel AS vtiger_inventoryproductreltmpSalesOrder ON (vtiger_inventoryproductreltmpSalesOrder.id = vtiger_salesorder.salesorderid)";
		}
		// End Hieu Nguyen
