...
class Events_Module_Model extends Calendar_Module_Model {
   ...
   /**
	...
	public function saveRecord(Vtiger_Record_Model $recordModel) {
        ...
        // Modified by Hieu Nguyen on 2019-11-21 to handle invitation
        Events_Invitation_Helper::saveInvitations($recordModel->get('id'), $recordModel->get('invitee_ids'), $recordModel->getData());
		// End Hieu Nguyen
    }
