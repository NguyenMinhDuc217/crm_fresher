...
Class Google_Calendar_Connector extends WSAPP_TargetConnector {
    ...
    public function getCalendar($SyncState, $user = false) {
        ...
        try {
            ...
            // Added by Hieu Nguyen on 2020-02-19 to write debug log
            Google_Utils_Helper::saveDebugLog('calendar', 'pull', '[Google->CRM] Calendar query exception', $e->getMessage());
            // End Hieu Nguyen
        ...
        foreach ($calendarRecords as $i => $calendar) {
            ...
            if (!$deleted) {
                ...
                // Added by Hieu Nguyen on 2020-02-19 to write debug log
                Google_Utils_Helper::saveDebugLog('calendar', 'pull', '[Google->CRM] Calendar new/updated event', $calendarRecords);
                // End Hieu Nguyen
            } else {
                $recordModel->setType($this->getSynchronizeController()->getSourceType())->setMode(WSAPP_SyncRecordModel::WSAPP_DELETE_MODE);
                
                // Added by Hieu Nguyen on 2020-02-19 to write debug log
                Google_Utils_Helper::saveDebugLog('calendar', 'pull', '[Google->CRM] Calendar deleted event', $calendarRecords);
                // End Hieu Nguyen
            }
        ...
        foreach ($records as $record) {
            ...
            try {
                if ($record->getMode() == WSAPP_SyncRecordModel::WSAPP_UPDATE_MODE) {
                    ...
                    // Added by Hieu Nguyen on 2020-02-19 to write debug log
                    Google_Utils_Helper::saveDebugLog('calendar', 'push', '[CRM->Google] Calendar event updated', $newEntity);
                    // End Hieu Nguyen
                    ...
                    // Added by Hieu Nguyen on 2020-02-19 to write debug log
                    Google_Utils_Helper::saveDebugLog('calendar', 'push', '[CRM->Google] Calendar event deleted', $newEntity);
                    // End Hieu Nguyen
                } else {
                    ...
                    // Added by Hieu Nguyen on 2020-02-19 to write debug log
                    Google_Utils_Helper::saveDebugLog('calendar', 'push', '[CRM->Google] Calendar event created', $newEntity);
                    // End Hieu Nguyen
                }
                
            } catch (Exception $e) {
                // Added by Hieu Nguyen on 2020-02-19 to write debug log
                Google_Utils_Helper::saveDebugLog('calendar', 'push', '[CRM->Google] Calendar push exception: '. $e->getMessage(), $entity);
                // End Hieu Nguyen
