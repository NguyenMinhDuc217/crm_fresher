...
class Google_Oauth2_Connector {
    ...
    // Modified by Hieu Nguyen on 2020-02-18 to standardize coding
    public function __construct($module, $userId = false) {
		...
		$this->client_id = $googleConfig['oauth']['client_id'];
		$this->client_secret = $googleConfig['oauth']['client_secret'];
		$this->redirect_uri = Google_Utils_Helper::getRedirectUrl();
