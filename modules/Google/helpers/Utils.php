...
class Google_Utils_Helper {
    ...
    // Added by Hieu Nguyen on 2020-02-18
    ...
    // Added by Hieu Nguyen on 2020-02-18
    static function saveDebugLog($dataType, $method, $description, $data) {
        global $googleConfig;
        if (!$googleConfig['debug'][$dataType][$method]) return;

        $logger = LoggerManager::getLogger('GOOGLE_INTEGRATION');

        // Save log
        $log = "Description: {$description}\r\n";
        $log .= 'Data: ' . json_encode((array) $data) . "\r\n";
        $log .= '==============================';
