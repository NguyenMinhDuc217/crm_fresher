 ...
 *************************************************************************************/
    $languageStrings = array(
        ...
        'LBL_ONLY_SYNC_FROM_GOOGLE_TO_VTIGER' => 'From Google to CloudPro CRM only',
        'LBL_ONLY_SYNC_FROM_VTIGER_TO_GOOGLE' => 'From CloudPro CRM to Google only',
        'Job Title' => 'Title',
        'Company' => 'Company',
        'Birthday' => 'Birthday',
        'Phone' => 'Phone',
        ...
        'LBL_PRIMARY' => 'Primary',
        'LBL_SYNC_FROM_GOOGLE_TO_VTIGER' => 'Sync from Google to CloudPro CRM',
        'LBL_SYNC_FROM_VTIGER_TO_GOOGLE' => 'Sync from CloudPro CRM to Google',
        ...
        'LBL_SYSTEM_DATA' => 'Data in %system_name',
    );
