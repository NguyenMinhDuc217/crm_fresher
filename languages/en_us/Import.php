...
$languageStrings = array(
	...
	'LBL_SAVE_AS_CUSTOM_MAPPING_PLACEHOLDER' => 'Enter display name for this configuration',
	...
	/*Add By Kelvin Thang -- Date: 2018-06-28*/
	'LBL_XLSX_FILE'=>'Excel File',
	'LBL_UPLOAD_XLSX'=>'Upload Excel File',
	'LBL_IMPORT_FROM_XLSX_FILE'=>'Import from Excel file',
	'LBL_SELECT_XLSX_FILE' => 'Select Excel file',

    // Added by Hieu Nguyen on 2020-09-10
    'LBL_TOTAL_RECORDS_CANCELLED' => 'Records cancelled',
    'LBL_IMPORT_LOCKED_BY_OTHER_USER' => 'The import process of %user_name in module %module_name is not finished yet. Please try again at another time or contact this user for more information.',
    // End Hieu Nguyen

    // Added by Hieu Nguyen on 2021-05-11
    'LBL_IMPORT_STEP2_SKIP_WARNING_FOR_ACCOUNTS' => 'You can skip this step but please note that module Accounts is always check duplicate by Account Name, so all records duplicate by Account Name will not be imported!',
    // End Hieu Nguyen

	// Added by Hieu Nguyen on 2021-09-07
	'LBL_IMPORT_FILE_HINT' => 'The import file must match the required fields and data format!',
	'LBL_DOWNLOAD_IMPORT_TEMPLATE_FILE' => 'Download template file',
	// End Hieu Nguyen

	// Added by Hieu Nguyen on 2021-10-15
	'LBL_ERROR_REASONS' => 'Error Reasons',
	'LBL_ERROR_REASONS_FIELD_VALUE_IS_EMPTY' => "%field_name's value empty!",
	'LBL_ERROR_REASONS_FIELD_VALUE_WRONG_FORMAT' => "%field_name's value wrong format!",
	'LBL_ERROR_REASONS_PICKLIST_VALUE_NOT_MATCH' => "%field_name's value not match!",
	'LBL_ERROR_REASONS_MULTIPICKLIST_VALUE_NOT_MATCH' => "%field_name's value not match [%invalid_options]!",
	// End Hieu Nguyen
);

$jsLanguageStrings = array(
    // Added by Hieu Nguyen on 2020-09-10
    'JS_IMPORT_COMPLETED_MSG' => 'Import Completed',
    // End Hieu Nguyen
);