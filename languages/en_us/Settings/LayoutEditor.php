...
$languageStrings = array(
	...
	'LBL_EDITVIEW_LAYOUT' => 'Edit View Layout',
	'LBL_DETAILVIEW_LAYOUT' => 'Detail View Layout',
	'LBL_TRANSLATION_EDITOR' => 'Translation Editor',
	...
	'LBL_COPY_LAYOUT_FROM_EDITVIEW' => 'Copy layout from Edit View',
	'LBL_FIELD_LABEL_KEY_NAME' => 'Label Key (Ex: LBL_FIELD_NAME)',
	'LBL_FIELD_LABEL_DISPLAY_NAME_EN' => 'Label Display (English)',
	'LBL_FIELD_LABEL_DISPLAY_NAME_VN' => 'Label Display (Vietnamese)',
	'LBL_FIELD_LABEL_DISPLAY_NAME' => 'Label Display (English)',
	'LBL_EDIT_BLOCK' => 'Edit Block',
	'LBL_BLOCK_LABEL_KEY_NAME' => 'Label Key (Ex: LBL_BLOCK_NAME)',
	'LBL_BLOCK_LABEL_DISPLAY_NAME_EN' => 'Label Display (English)',
	'LBL_BLOCK_LABEL_DISPLAY_NAME_VN' => 'Label Display (Vietnamese)',
	'LBL_TRANSLATION_EDITOR_LABEL_KEY' => 'Language Key',
	'LBL_TRANSLATION_EDITOR_ENGLISH' => 'English',
	'LBL_TRANSLATION_EDITOR_VIETNAMESE' => 'Vietnamese',
	'LBL_TRANSLATION_EDITOR_SAVE_ALL' => 'Save All Translation',
	'LBL_TRANSLATION_EDITOR_SAVE_ENGLISH' => 'Save English Translation',
	'LBL_TRANSLATION_EDITOR_SAVE_VIETNAMESE' => 'Save Vietnamese Translation',
	'LBL_BTN_ADD_RELATIONSHIP' => 'Add new Relationship',
	'LBL_RELATIONSHIP_EDITOR_MODAL_TITLE' => 'Add new Relationship',
	'LBL_RELATIONSHIP_EDITOR_LEFT_SIDE_MODULE' => 'Current Module (Module A)',
	'LBL_RELATIONSHIP_EDITOR_RIGHT_SIDE_MODULE' => 'Relate Module (Module B)',
	'LBL_RELATIONSHIP_EDITOR_RELATE_TYPE' => 'Relate Type',
	'LBL_RELATIONSHIP_EDITOR_LISTING_FUNCTION_NAME' => 'Listing Function Name (RelatedList)',
	'LBL_RELATIONSHIP_EDITOR_LEFT_SIDE_MODULE_REFERENCE_FIELD' => "Module A's reference field name",
	'LBL_RELATIONSHIP_EDITOR_RIGHT_SIDE_MODULE_REFERENCE_FIELD' => "Module B's reference field name",
	'LBL_RELATIONSHIP_EDITOR_RELATION_LABEL_KEY' => 'Relationship name language key',
	'LBL_RELATIONSHIP_EDITOR_RELATION_LABEL_DISPLAY_EN' => 'Relationship display name (English)',
	'LBL_RELATIONSHIP_EDITOR_RELATION_LABEL_DISPLAY_VN' => 'Relationship display name (Vietnamese)',
	// End Hieu Nguyen

    // Added by Hieu Nguyen on 2019-10-09
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT' => 'Popup & Relation List Layouts',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_UNSUPPORTED_MODULE_HINT' => 'This module does not support custom layout for Popup & Relation List!',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_POPUP_LAYOUT' => 'Popup layout',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_RELATION_LIST_LAYOUT' => 'Relation List layout',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_DISPLAY_FIELDS' => 'Display fields',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_SORT_FIELD' => 'Sort by field',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_SORT_ORDER' => 'Sort by order',
    // End Hieu Nguyen

	// Added by Hieu Nguyen on 2021-07-29
	'LBL_DELETE_CUSTOM_BLOCK_CONTAINS_FIELDS_ERROR_MSG' => 'You can not delete block that containing fields!',
	'LBL_DELETE_SYSTEM_BLOCK_ERROR_MSG' => 'You can not delete a system block! Please reload the page to see the latest layout.',
	'LBL_DELETE_SYSTEM_BLOCK_ERROR_MSG_FOR_DEV' => 'Developer can not delete a block created by R&D or Customer! Please reload the page to see the latest layout.',
	'LBL_DELETE_SYSTEM_FIELD_ERROR_MSG' => 'You can not delete a system field! Please reload the page to see the latest layout.',
	'LBL_DELETE_SYSTEM_FIELD_ERROR_MSG_FOR_DEV' => 'Developer can not delete a field created by R&D or Customer! Please reload the page to see the latest layout.',
	// End Hieu Nguyen
);
...
$jsLanguageStrings = array(
	...
	'JS_SPECIAL_CHARACTERS' => 'Special Characters',
	...
	// Added by Hieu Nguyen on 2018-08-01
	'JS_COPY_LAYOUT_FROM_EDITVIEW_CONFIRM_MSG' => 'Are you sure to override all layouts in Detail View? Warning: This action can not be undone!',
	'JS_COPY_LAYOUT_FROM_EDITVIEW_SUCCESS_MSG' => 'Layouts copied Edit View to Detail View successfully!',
	'JS_COPY_LAYOUT_FROM_EDITVIEW_ERROR_MSG' => 'Error while copying layouts from Edit View to Detail View. Please try again!',
	'JS_UPDATE_BLOCK_INFO_SUCCESS_MSG' => 'Block info updated successfully',
	'JS_TRANSLATION_EDITOR_SAVE_CONFIRM_MSG' => 'Are you sure to save this translation?',
	'JS_TRANSLATION_EDITOR_SAVE_SUCCESS_MSG' => 'Translation saved successfully!',
	'JS_TRANSLATION_EDITOR_SAVE_ERROR_MSG' => 'Error while saving translation. Please try again!',
	'JS_RELATIONSHIP_EDITOR_CREATE_RELATIONSHIP_SUCCESS_MSG' => 'Relationship created successfully!',
	'JS_RELATIONSHIP_EDITOR_CREATE_RELATIONSHIP_ERROR_MSG' => 'Can not create relationship. Please try again!',
	'JS_RELATIONSHIP_EDITOR_MODULE_NOT_EXISTS_ERROR_MSG' => 'Module is not exists!',
	'JS_RELATIONSHIP_EDITOR_RELATIONSHIP_N2N_EXISTS_ERROR_MSG' => 'Only 1 N:N relationship be allowed between 2 modules!',
	'JS_RELATIONSHIP_EDITOR_RELATIONSHIP_EXISTS_ERROR_MSG' => 'The relationship you want to create is already exists!',
	'JS_RELATIONSHIP_EDITOR_LEFT_SIDE_REFERENCE_FIELD_EXISTS_ERROR_MSG' => 'This field is already exists in module A',
	'JS_RELATIONSHIP_EDITOR_RIGHT_SIDE_REFERENCE_FIELD_EXISTS_ERROR_MSG' => 'This field is already exists in module B',
	// End Hieu Nguyen

    // Added by Hieu Nguyen on 2019-05-31
    'JS_NON_UNICODE_REQUIRED' => 'You must enter value in English, or non-unicode string!',
    // End Hieu Nguyen

    // Added by Hieu Nguyen on 2019-10-10
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_POPUP_LAYOUT_VALIDATION_MIN_LENGTH_ERROR_MSG' => 'Popup requires at least %s fields!',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_RELATION_LIST_LAYOUT_VALIDATION_MIN_LENGTH_ERROR_MSG' => 'Relation List requires at least %s fields!',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_SAVE_CONFIRM_MSG' => 'Are you sure to save these layouts?',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_ERROR_MSG' => 'Can not save these layouts. Please try again!',
    'LBL_POPUP_AND_RELATION_LIST_LAYOUT_SAVE_SUCCESS_MSG' => 'Layouts save successfully!',
    // End Hieu Nguyen

	// Added by Hieu Nguyen on 2021-07-29
	'JS_DELETE_CUSTOM_BLOCK_CONFIRM_MSG' => 'Are you sure to delete this block?'
	// End Hieu Nguyen
);
