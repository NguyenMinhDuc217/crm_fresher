...
$languageStrings = array(
	...
	'LBL_MAILCONVERTER_DESCRIPTION' => "Mail Converter enables you to configure your mailbox to scan your emails and create appropriate entities in CloudPro CRM.<br />You'll also need to define rules to specify what actions should be performed on your emails.<br />Your emails are scanned automatically, unless you've disabled Mail Scanner task in Scheduler. <br /><br /><br />",
    ...
    'LBL_EMAIL_BODY_INFO' => 'Copy text from a sample email to be scanned into the below box. CloudPro CRM will try to locate values and help you map to CRM fields.',
