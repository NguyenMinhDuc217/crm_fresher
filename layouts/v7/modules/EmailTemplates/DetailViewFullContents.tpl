	...
	<div class="detailview-content container-fluid">
		<div class="details row">
			<div class="block">
				...
				<div>
					<h4>{vtranslate('LBL_GENERAL_INFORMATION')}</h4>
				</div>
				<hr>
					...
					<tbody> 
						...
						<tr>
							...
							<td class="fieldValue {$WIDTHTYPE}" colspan="3">
								<iframe id="TemplateIFrame" style="height:550px;" class="col-sm-12 col-xs-12 overflowScrollBlock"></iframe>
							</td>
						</tr>
					</tbody>
				</table>
