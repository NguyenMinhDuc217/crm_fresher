                ...
                {if $IS_SYNC_READY eq 'no'}
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-xs-3">
                            <a id="authorizeButton" class="btn btn-block btn-social btn-lg btn-google-plus" data-url='index.php?module={$MODULENAME}&view=List&operation=sync&sourcemodule={$SOURCE_MODULE}'><i class="fab fa-google-plus"></i>{vtranslate('LBL_SIGN_IN_WITH_GOOGLE', $MODULENAME)}</a>
                        </div>
                    </div>
                {else}            
        ...
        <div class="modal-overlay-footer clearfix">
            <div class="row clearfix">
                <div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
                    ...
                    <button class="btn addButton btn-success syncNow" type="button" id="saveSettingsAndImport"><span aria-hidden="true" class="far fa-download"></span>&nbsp; {vtranslate('LBL_SAVE_AND_IMPORT', $MODULENAME)}</button>
                    &nbsp;&nbsp;&nbsp;
                    {/if}
