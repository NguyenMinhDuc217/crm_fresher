...
Vtiger.Class("Google_Map_Js", {}, {
	...
	showMap : function(container) {
		...
		app.request.post({"data":params}).then(function(error,response){
			...
			if(location != '' && location != null){
				...
				app.helper.showAlertNotification({message:app.vtranslate('JS_ADDRESS_INFORMATION_REQUEST_TO_VIEW_ON_MAP')});
				return false;
			}
	...
	loadMapScript : function() {
		/*--Add by Kelvin Thang -- Date: 2018-07-05 */
		//googleApiKey = 'AIzaSyDzRXThNnMKYSVDa6DglJViyCzlWWamHLo';	// Commented out this line by Hieu Nguyen on 2018-08-30 as it's already exposed in header.tpl
		/*googleApiKey = 'AIzaSyDRT9tGHgTZNW_9ylXnMwJBQQgWRLifVaw';*/
		jQuery.getScript("https://maps.google.com/maps/api/js?key=" + googleApiKey + "&sensor=true&async=2&callback=initialize", function () {});
	},
