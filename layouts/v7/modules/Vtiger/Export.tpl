							...
							{if $SOURCE_MODULE eq 'Calendar'}
								...
								<div style="margin-left: 50px;">
									<div>
										...
										<label style="font-weight:normal" for="csv">&nbsp;&nbsp;{vtranslate('Excel', $MODULE)}</label>	{* Modified label by Hieu Nguyen on 2021-12-28 *}
									</div>
									<div>
										<input type="radio" name="type" value="ics" id="ics" onchange="Calendar_Edit_Js.handleFileTypeChange();"/>
										<label style="font-weight:normal" for="ics">&nbsp;&nbsp;{vtranslate('ICS', $MODULE)}</label>	{* Modified label by Hieu Nguyen on 2021-12-28 *}
									</div>
								</div>
							{/if}
