...
-->*}
{strip}
	<div class="row" style="width:auto;"> {* Modified by Phuc on 2019.11.18 to change width *}
		<div>
		...
		<div class="" id="repeatUI" style="visibility: {if $RECURRING_INFORMATION['recurringcheck'] eq 'Yes'}visible{else}collapse{/if};">
			<div>
				...
				<span>
					<span class="alignMiddle displayInlineBlock">&nbsp;&nbsp;{vtranslate('LBL_UNTIL', $MODULE)}&nbsp;&nbsp;</span> {* Modified by Phuc on 2019.11.18 to display text balance before and after *}
					<span class="input-group date inputElement no-float"> {* Modified by Phuc on 2019.11.18 to update class *}
			...
			<div class="{if $RECURRING_INFORMATION['eventrecurringtype'] eq 'Monthly'}show{else}hide{/if}" id="repeatMonthUI" style="margin-top:10px;"RCa>
				...
				<div class="row" id="repeatMonthDayUI" style="margin-top: 10px;">
					...
					<span class="col-lg-2">
						<select id="repeatMonthDayType" class="select2" name="repeatMonth_daytype" style="width: 110px;">
