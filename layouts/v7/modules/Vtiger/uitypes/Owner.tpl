...
{if $FIELD_MODEL->get('uitype') eq '53'}
	...
	{* Added by Phu Vo on 2019.06.17 Assign field label incase create tpl missing *}
	{if $FIELD_NAME eq ''} {assign var=FIELD_NAME value=$FIELD_MODEL->get('name')} {/if}
	{* End Assign field label incase create tpl missing *}

	{if $FIELD_VALUE eq ''}
		{assign var=FIELD_VALUE value=$CURRENT_USER_ID}
	{/if}

    {* Modified by Hieu Nguyen on 2019-05-21 *}
    ...
    {include file='modules/Vtiger/tpls/CustomOwnerField.tpl'}
    {* End Hieu Nguyen *}
{/if}
