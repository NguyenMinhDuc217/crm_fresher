...
{strip}
	...
	<div class="fileUploadContainer text-left">
		<div class="fileUploadBtn btn btn-sm btn-primary">
			<span><i class="far fa-laptop"></i> {vtranslate('LBL_ATTACH_FILES', $MODULE)}</span>
		...
		<span class="uploadFileSizeLimit far fa-info-circle" data-toggle="tooltip" data-placement="top" title="{vtranslate('LBL_MAX_UPLOAD_SIZE',$MODULE)} {$MAX_UPLOAD_LIMIT_MB} {vtranslate('MB',$MODULE)}">
