...
{strip}
    ...
    {* Added by Phu Vo on 2021.01.13 to load vue js libraries and utils globally *}
    {if $CURRENT_USER_MODEL}
        <script src="{vresource_url('resources/libraries/Vue/vue-bootstrap-datetimepicker.js')}"></script>
        <script src="{vresource_url('resources/libraries/Vue/common.vue.js')}"></script>
    {/if}
    {* End Phu Vo *}
    ...
    {* Commented out these lines by Hieu Nguyen on 2020-07-23 as it is useless but sometimes cause error '_PAGEREADYAT is not defined' *}
