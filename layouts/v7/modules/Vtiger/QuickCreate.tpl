...
{strip}
    ...
    {* Modified by Hieu Nguyen on 2018-08-23 to load custom code *}
    ...
    <div class="modal-dialog modal-lg QuickCreate">
                            ...
                            <tr>
                                ...
                                {foreach key=FIELD_NAME item=FIELD_MODEL from=$RECORD_STRUCTURE name=blockfields}
                                    ...
                                    {if $FIELD_MODEL->get('uitype') neq '83'}
                                        <td class="fieldValue {$FIELD_NAME} col-lg-4" {if $FIELD_MODEL->get('uitype') eq '19'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}> {* Added by Phu Vo on 2019.06.11 to add field name to fieldValue holder*}
