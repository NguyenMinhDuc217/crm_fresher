                ...
                <div class="modal-body">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-4 input-group">
							 ...
							 {/foreach}
                                ...
                                <a href="#" class="clearReferenceSelection cursorPointer" name="clearToEmailField"><i class="far fa-times-circle"></i></a>
                                <span class="input-group-addon">
                                    <span class="selectEmail cursorPointer">
                                        <i class="far fa-search" title="{vtranslate('LBL_SELECT', $MODULE)}"></i>
                                    </span>
                                </span>
                            </div>
                            </div>
                    ...
                    <div class="row subjectField">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="subject" value="{htmlentities($SUBJECT)}" data-rule-required="true" id="subject" spellcheck="true" class="inputElement"/>  {* Modified by Hieu Nguyen on 2021-10-22 to escape special characters from rendering HTML to avoid error *}
                            </div>
                            <div class="col-lg-4"></div>
                        </div>
                    </div>
