...
<div class="module-action-bar clearfix">
    <div class="module-action-content clearfix row">
        <div class="col-lg-4 col-md-4 col-sm-4">
            ...
            <div>
                <p class="current-filter-name pull-left"><span class="far fa-chevron-right" aria-hidden="true"></span>&nbsp;{$VIEW}&nbsp;</p>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
                    ...
                    {if $LISTVIEW_LINKS['LISTVIEWSETTING']|@count gt 0}
                        <div class="settingsIcon">
                            <button type="button" class="btn btn-default module-buttons dropdown-toggle" data-toggle="dropdown">
                                <span class="far fa-wrench" aria-hidden="true" title="{vtranslate('LBL_SETTINGS', $MODULE)}"></span>&nbsp; <i class="far fa-angle-down"></i>
                            </button>
