                        ...
                        <div class="row">
                                    ...
                                    <div class="currentTagScroll">
                                        <div class="currentTag multiLevelTagList form-control">
                                            ...
                                            {foreach item=TAG_MODEL from=$TAGS_LIST}
                                                {include file="Tag.tpl"|vtemplate_path:$MODULE POPUP=true} {* Modified by Phu Vo on 2021.11.16 *}
                                            {/foreach}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu currentTagMenu">
                                            <div class="scrollable" style="max-height:100px"> {* Modified by Phu Vo on 2021.11.16 *}
                            ...
                            <div class=" col-lg-6 selectTagContainerborder">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input name="createNewTag" data-rule-maxsize="25" value="" class="form-control" placeholder="{vtranslate('LBL_ENTER_TAG_NAME',$MODULE)}"/>
                                    </div>
                               </div>
                               <div class="form-group">
                                    <div>
                                ...
                                <div class="form-group">
                                    <div class=" vt-default-callout vt-info-callout tagInfoblock">
                                        ...
                                        <span class="far fa-info-circle"></span>&nbsp; {vtranslate('LBL_INFO')} </h5>
