...
{strip}
	<div class="modal-dialog modal-lg configColumnsContainer">
		<div class="modal-content">
			...
			{assign var=VIEW_NAME value=$CV_MODEL->get('viewname')}
			{if $VIEW_NAME == 'All'}{assign var=VIEW_NAME value=vtranslate('All')}{/if}
						...
						<div class="col-lg-6 selectedFieldsContainer">
							...
							<div class="selectedFieldsListContainer">   
								<ul id="selectedFieldsList">
									{foreach item=FIELD_MODEL from=$SELECTED_FIELDS}
                                        ...
                                        <li class="item" data-cv-columnname="{$FIELD_MODEL->getCustomViewColumnName()}" data-columnname="{$FIELD_MODEL->get('column')}" data-field-id='{$FIELD_MODEL->getId()}'>
                                            ...
                                            <span class="pull-right dragContainer">
												<i class="far fa-grip-lines cursorPointerMove" border="0" title="{vtranslate('LBL_DRAG',$MODULE)}"></i>
                                            </span>
                                            <span class="pull-right removeField"><i class="far fa-times" title="{vtranslate('LBL_REMOVE',$MODULE)}"></i></span>
                                        </li>   
									{/foreach}
								</ul>
								<li class="item-dummy hide">
									...
									<span class="pull-right removeField"><i class="far fa-times"></i></span>
								</li>
							</div>
						</div>
						<div class="col-lg-6 availFiedlsContainer">
							<div class="row">
								<div class="col-lg-12"> {* Modified by Phu Vo on 2021.05.21 to resize availabel field width *}
												...
												<div class="instafilta-section">
													<div id="{$RAND_ID}_accordion" class="availFieldBlock" role="tab">
														<a class="fieldLabel" data-toggle="collapse" data-parent="#accordion" href="#{$RAND_ID}">
															<i class="far fa-chevron-right"></i><span>{vtranslate($BLOCK_LABEL, $SOURCE_MODULE)}</span>
														</a>
													</div>
