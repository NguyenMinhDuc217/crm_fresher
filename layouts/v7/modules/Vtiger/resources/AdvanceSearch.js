...
Vtiger_BasicSearch_Js("Vtiger_AdvanceSearch_Js",{
	...
	performSearch : function() {
		...
		this.search().then(function(data){
			...
			app.event.trigger('post.globalSearchResult.load', jQuery('.searchResults'));
			// End Phu Vo

			// Added by Phu Vo on 2021.12.27 to fix global search list don't have scroll bar
			app.helper.showHorizontalScroll(jQuery('.searchResults').find('.listViewPageDiv .table-container'));
			// End Phu Vo
		});
	},
	...
	performValidation : function() {
		...
		if(!this.filterValidationRegistered){
            ...
            // Temporary comment out this line by Hieu Nguyen on 2019-06-13 to prevent error from submit as no library loaded for this purpose
