...
Vtiger.Class('Vtiger_MergeRecords_Js',{},{
    ...
    registerUIEvents : function(container) {
        ...
        // Added by Hieu Nguyen on 2021-10-01 to get correct main_owner_id 
        container.find('[name="assigned_user_id"]').on('change', function (event) {
            var mainOwnerInput = $(this).closest('div.checkbox').find('[name="main_owner_id"]');
            mainOwnerInput.prop('checked', true);
		});
        // End Hieu Nguyen
