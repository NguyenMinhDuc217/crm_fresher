...
<div class="col-sm-12 col-xs-12 extensionContents">
            ...
            <div class="col-sm-6 col-xs-6">
                <div class="pull-right">
                    <span class="module-title">
                        <h3><a data-url="{$MODULE_MODEL->getExtensionSettingsUrl($SOURCE_MODULE)}" class="btn addButton btn-default settingsPage" type="button" id="Contacts_basicAction_LBL_Sync_Settings"><span aria-hidden="true" class="far fa-cog"></span> {vtranslate('LBL_SYNC_SETTINGS', $MODULE)}</a></h3>
                    </span>
                </div>
            </div>
        {/if}
    ...
    <div class="row">
        {if !$MODAL}
            <div class="col-sm-6 col-xs-6">
                {if $IS_SYNC_READY}
                    <button class="btn addButton btn-success syncNow" type="button" id="Contacts_basicAction_LBL_Sync_Settings"><span aria-hidden="true" class="far fa-refresh"></span><strong>&nbsp; {vtranslate('LBL_SYNC_NOW', $MODULE)} </strong></button>
                        {/if}
            </div>
        {/if}
        {if !$MODAL}
