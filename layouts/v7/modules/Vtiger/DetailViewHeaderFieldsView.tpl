        ...
        {if $FIELD_MODEL->isHeaderField() && $FIELD_MODEL->isActiveField() && $RECORD->get($FIELD_NAME) && $FIELD_MODEL->isViewable()}
            ...
            <div class="info-row row headerAjaxEdit td">
                <div class="col-lg-7 fieldLabel">
                    ...
                    {if $FIELD_MODEL->isEditable() eq 'true' && $LIST_PREVIEW neq 'true' && $IS_AJAX_ENABLED eq 'true' && $FIELD_MODEL->isAjaxEditable() eq 'true'} {* Added by Tin Bui on 2022.04.19 - Bug #3288 *}
                        ...
                        <span class="action">
                            <a href="#" onclick="return false;" class="editAction far fa-pen"></a>
                        </span>
                    {/if}
                </div>
            </div>
