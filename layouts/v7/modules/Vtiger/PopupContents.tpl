            ...
            <div class="popupEntriesTableContainer {if $MODULE eq 'EmailTemplates'} emailTemplatesPopupTableContainer{/if}">
                    ...
                    <tr class="searchRow">
                        <td class="textAlignCenter">
                            <div class="table-actions flex-actions">
                                <i class="far fa-eraser clearFilters" onclick="Vtiger_Popup_Js.clearFilters()" aria-hidden="true" data-toggle="tooltip" title="{vtranslate("LBL_CLEAR_FILTERS", $MODULE)}"></i>
                ...
                {foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES name=popupListView}
                    ...
                    <td class="listViewEntryValue value textOverflowEllipsis {$WIDTHTYPE}" title="{$RECORD_DATA[$LISTVIEW_HEADERNAME]}">
                        ...
                        {else if $LISTVIEW_HEADER->get('name') === 'salutationtype'}
                        ...
                        {else if $LISTVIEW_HEADER->getFieldDataType() eq 'owner'}
                            {assign var=OWNER_RAW_VALUE value=$LISTVIEW_ENTRY->getRaw($LISTVIEW_HEADER->get('column'))}
