...
<div class="container-fluid">
	<div class="row">
		{* Modified by Phu Vo on 2020.12.25 to translate view header properly *}
		{$replaceParams = ['%module_name' => vtranslate($MODULE, $MODULE)]}
		{assign var=HEADER_TITLE value={vtranslate('LBL_DUPLICATED_RECORDS', $MODULE, $replaceParams)}}
		{* End Phu Vo *}
		<h3>
			<div class="col-lg-7">
				{$HEADER_TITLE}
			...
			<div class="col-lg-5">
				<div class="alert alert-static">
					<span class="far fa-info-circle icon"></span>
