...
{else}
	<span class="noDataMsg" style="position: relative; top: 115.5px; left: 119px;">
        {* Modified by Phu Vo on 2020.12.18 to fix concat string translation issue *}
        {vtranslate('LBL_NO_RECORD_MATCHED_THIS_CRITERIA', $PRIMARY_MODULE, ['%module_name' => vtranslate($PRIMARY_MODULE, $PRIMARY_MODULE)])}
        {* End Phu Vo *}
	</span>
{/if}