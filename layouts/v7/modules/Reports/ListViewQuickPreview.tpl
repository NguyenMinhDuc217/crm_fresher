        ...
        <div class='modal-body'>
            <div class="quickPreviewModuleHeader row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="record-header clearfix">
                                <div class="hidden-sm hidden-xs recordImage">
                                    <div class="name"><span class='fad fa-chart-bar'></span></div>
                                </div>
                ...
                <div class = "col-lg-2 pull-right">
                    <button class="close" aria-hidden="true" data-dismiss="modal" type="button" title="{vtranslate('LBL_CLOSE')}"><i class="far fa-times"></i></button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    {* Comment out by Phu Vo on 2019.06.26 => move to list view preview chart call back *}
    {* jQuery('.quickPreviewSummary').trigger(Vtiger_Widget_Js.widgetPostLoadEvent); *}
    {* End move to list view preview chart call back *}
</script>