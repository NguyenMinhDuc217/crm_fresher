...
{strip}
        <div class="reportsDetailHeader">
            ...
            <input type="hidden" id="custom_handler_file" value="{$REPORT_MODEL->get('custom_handler_file')}" />
            {* End Hieu Nguyen *}
            ...
            <form id="detailView" onSubmit="return false;">
                ...
                <button type="button" id="toggle-filter" class="btn btn-default">
                    <strong>{vtranslate('LBL_MODIFY_CONDITION', $MODULE)}</strong>&nbsp;&nbsp;
                    <i class="far fa-chevron-down"></i>
                </button>
                {* End Hieu Nguyen *}

                <div id="filterContainer" class="filterElements filterConditionsDiv hide">  {* Modified by Hieu Nguyen on 2022-01-24 to hide report filter by default *}
