...
* All Rights Reserved.
*************************************************************************************}
{* Modified by Hieu Nguyen on 2021-08-20 to check if this feature can by displayed *}

{strip}
    {assign var=show_report_scheduled value=!isForbiddenFeature('ScheduleAutoReports')}
    ...
    {if $show_report_scheduled eq true}
        <div class="row">
            <div>
                ...
                {* Added by Hieu Nguyen on 2021-09-29 to display help text *}
                &nbsp;
                <span title="{vtranslate('LBL_SCHEDULE_REPORT_HINT', $MODULE)}" data-toggle="tooltip"><i class="far fa-info-circle"></i></span>
                {* End Hieu Nguyen *}
            </div>
        </div>
