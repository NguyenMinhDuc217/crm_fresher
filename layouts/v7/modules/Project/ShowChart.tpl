                            ...
                            <td>
                                <div class="row">
                                    ...
                                    {if $STATUS_FIELD_MODEL->isEditable()}
                                        <div class="col-lg-3">
                                            <a onclick="javascript:Project_Detail_Js.showEditColorModel('index.php?module={$MODULE}&view=EditAjax&mode=editColor&status={$STATUS_NAME}', this)" data-status="{$STATUS_NAME}" data-color="{$TASK_STATUS_COLOR[$STATUS_NAME]}"><i title="{vtranslate('LBL_EDIT_COLOR', $MODULE)}" class="far fa-pen alignMiddle"></i></a>&nbsp;
                                        </div>
                                    {/if}
                                </div>
                            </td>
