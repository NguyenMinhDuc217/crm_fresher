    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form class="form-horizontal" method="post" action="index.php" id="recipientsForm">
               ...
               <div id="multiEmailContainer" class="modal-body">
                    ...
                    <div class='padding20'>
                        ...
                        {assign var=MODULE_NAME value={getTabname($EMAIL_MODULE_ID)}}
                            <div><strong>{vtranslate('SINGLE_'|cat:$MODULE_NAME, $MODULE_NAME)}</strong></div>
                            <div class="form-group">
                                {foreach item=EMAIL_FIELD key =EMAIL_FIELD_NAME from=$FIELDS_INFO}
                                    <label class="checkbox" style="padding-left: 50px;">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header" style="border-bottom: none;">
                    <button data-dismiss="modal" class="close" title="{vtranslate('LBL_CLOSE')}"><i class="far fa-times"></i></button>
                </div>
