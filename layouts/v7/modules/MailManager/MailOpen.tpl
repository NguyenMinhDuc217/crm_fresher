    ...
    <div class="container-fluid padding0px">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                {if $ATTACHMENT_COUNT}
                    &nbsp;&nbsp;<i class="far fa-paperclip fontSize20px"></i>
                {/if}
                <span> 
                    ...
                    <a href="javascript:void(0)" class="emailDetails" role="tooltip" data-toggle="popover" data-trigger="focus" title="<strong>{vtranslate('LBL_DETAILS', $MODULE)}</strong>" 
                        ...
                        <i class="far fa-angle-down" title="{vtranslate('LBL_SHOW_FULL_DETAILS', $MODULE)}" style='border: 1px solid #AAA; padding: 0 2px; color: #AAA;'></i> 
                    </a> 
                </span>
            </div>
            <div class="col-lg-4">
        ...
        <div class="clearfix">
                <div class="pull-right">
                    <span class="cursorPointer mmDetailAction" id='mmPrint' title='{vtranslate('LBL_Print', $MODULE)}'><i class="far fa-print"></i></span>
                    <span class="cursorPointer mmDetailAction" id='mmReply' title='{vtranslate('LBL_Reply', $MODULE)}'><i class="far fa-reply"></i></span>
                    <span class="cursorPointer mmDetailAction" id='mmReplyAll' title='{vtranslate('LBL_Reply_All', $MODULE)}'><i class="far fa-reply-all"></i></span>
                    <span class="cursorPointer mmDetailAction" id='mmForward' title='{vtranslate('LBL_Forward', $MODULE)}'><i class="far fa-share"></i></span>
                    <span class="cursorPointer mmDetailAction" id='mmDelete' title='{vtranslate('LBL_Delete', $MODULE)}' style="border-right: 1px solid #BBBBBB;"><i class="far fa-trash-alt"></i></span>
            </div>
        </div>
            <br>
        <div class="row">
            ...
            <div class='col-lg-12 padding0px'>
                ...
                {foreach item=ATTACHVALUE from=$ATTACHMENTS name="attach"}
                    ...
                    {if $INLINE_ATT[$ATTACHNAME] eq null}
                        ...
                        <span>
                            <i class="far {$MAIL->getAttachmentIcon($ATTACHVALUE['path'])}"></i>&nbsp;&nbsp;
