		...
		<div class="module-action-content clearfix">
			<div class="col-lg-7 col-md-7 module-breadcrumb">
				...
				{if $VIEWID}
					...
					{/foreach}
					<span>
						<p class="current-filter-name filter-name pull-left"><span class="far fa-angle-right" aria-hidden="true"></span>&nbsp;{$CVNAME}&nbsp;</p>
					</span>
				{/if}
			</div>
					...
					<ul class="nav navbar-nav">
						...
						<li>
							<button class="btn btn-default addBookmark addButton module-buttons" >
								<i class="far fa-plus"></i>&nbsp;&nbsp;{vtranslate('LBL_ADD_BOOKMARK',$MODULE)}</i>
							</button>
						</li>
					</ul>
				</div>
