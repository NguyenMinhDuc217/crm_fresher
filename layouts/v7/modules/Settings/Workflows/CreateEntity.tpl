...
{* Modified by Hieu Nguyen on 2020-07-01 *}
...
<div class="conditionsContainer" id="save_fieldvaluemapping">
	{if $RELATED_MODULE_MODEL_NAME neq '' && getTabid($RELATED_MODULE_MODEL_NAME)}
		...
		{assign var=FIELD_VALUE_MAPPING value=$TASK_OBJECT->field_value_mapping}    {* Modified by Hieu Nguyen on 2020-07-01 *}
		{foreach from=$FIELD_VALUE_MAPPING item=FIELD_MAP}
			...
			<div class="row conditionRow form-group">
				...
				<span class="fieldUiHolder col-lg-4" 
                    {if $FIELD_MAP['fieldname'] == 'assigned_user_id'}
                        data-assign-parent-record-owners="{$TASK_OBJECT->assign_parent_record_owners}"
