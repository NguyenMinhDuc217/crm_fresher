...
{strip}
	<div style="width: 100%; float: left; padding-left: 15px; padding-right: 15px">
	...
	<div class="col-sm-12 col-xs-12 ">
		<div id="table-content" class="floatThead-wrapper table-container" style="padding-top:0px !important;">
						...
						<tr class="listViewEntries" data-id="{$LISTVIEW_ENTRY->getId()}"
							...
							{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
								...
								{elseif $LISTVIEW_HEADERNAME eq 'module_name' && empty($SOURCE_MODULE)}
									<td class="listViewEntryValue {$WIDTHTYPE}" width="{$WIDTH}%" nowrap>
										<div class="workflow-module-icon">
