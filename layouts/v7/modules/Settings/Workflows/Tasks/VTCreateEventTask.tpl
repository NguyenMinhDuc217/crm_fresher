        ...
        <div class="col-sm-9 col-xs-9">
            <div class="row form-group">
                ...
                <div class="col-sm-9 col-xs-9">
                    ...
                    <input data-rule-required="true" class="inputElement" name="eventName" type="text" value="{htmlentities($TASK_OBJECT->eventName)}" />
                    {* End Hieu Nguyen *}
            ...
            <div class="row form-group">
                {* Modified by Hieu Nguyen on 2020-07-01 to render custom owner field *}
                <div class="col-sm-2 col-xs-2">{vtranslate('LBL_ASSIGNED_TO', $QUALIFIED_MODULE)} <span class="redColor">*</span></div>
                <div class="col-sm-5 col-xs-5 fieldValue assigned_user_id"> {* [Workflow] Edit by Phu Vo on 2020.08.03 to support custom logic need fieldname to trigger *}
                    ...
                    {include file="layouts/v7/modules/Settings/Workflows/Tasks/CustomOwnerField.tpl" FIELD_VALUE=$TASK_OBJECT->assigned_user_id FOR_EVENT=true}
                    <label><input type="checkbox" name="assign_parent_record_owners" {if $TASK_OBJECT->assign_parent_record_owners == 1}checked{/if} /> {vtranslate('LBL_ASSIGN_TO_PARENT_RECORED_OWNERS', $QUALIFIED_MODULE)}<label>
                </div>
                {* End Hieu Nguyen *}
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-4 col-xs-4">
                                    <span class="input-group date">
                                        ...
                                        <span class="input-group-addon"><i class="far far fa-calendar"></i></span>
                                    </span>
                                </div>
                            </div>
