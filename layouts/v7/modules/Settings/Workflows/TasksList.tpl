						...
						<td>
                            <div class="pull-left actions">
								<span class="actionImages">
									<a data-url="{$TASK->getV7EditViewUrl()}">  {* Modified by Hieu Nguyen on 2020-07-02 to use latest view *}
										<i class="far fa-pen alignMiddle" title="{vtranslate('LBL_EDIT',$QUALIFIED_MODULE)}"></i>
                                    </a>&nbsp;&nbsp;
									<a class="deleteTask" data-deleteurl="{$TASK->getDeleteActionUrl()}">
										<i class="far fa-trash-alt alignMiddle" title="{vtranslate('LBL_DELETE',$QUALIFIED_MODULE)}"></i>
									</a>
								</span>
                            </div>&nbsp;&nbsp;
                ...
                <tr class="listViewEntries hide taskTemplate">
                    <td>
                        <div class="pull-left actions">
                            <span class="actionImages">
                                <a class="editTask">
                                    <i class="far fa-pen alignMiddle" ></i>
                                </a>&nbsp;&nbsp;
                                <a class="deleteTaskTemplate">
                                    <i class="far fa-trash-alt alignMiddle"></i>
                                </a>
                            </span>
                        </div>&nbsp;&nbsp;
