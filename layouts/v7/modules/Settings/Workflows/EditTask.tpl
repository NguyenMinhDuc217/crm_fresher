...
-->*}
{strip}
   {* Added by Hieu Nguyen on 2021-11-16 to get SMS provider info for SMS task *}
   {if $TASK_TYPE_MODEL->get('tasktypename') == 'VTSMSTask'}
                     ...
                     <div class="row form-group">
                        <div class="col-sm-6 col-xs-6">
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-xs-9"><input name="summary" class="inputElement" data-rule-required="true" type="text" value="{htmlentities($TASK_MODEL->get('summary'))}" /></div>
                                {* End Hieu Nguyen *}
                            </div>
                        </div>
                     </div>
