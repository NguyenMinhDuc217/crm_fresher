			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="controls col-sm-9 col-xs-9">
						...
						&nbsp;&nbsp;
						<span class="far fa-info-circle" id="helpSecurityCode" onmouseover="Settings_ExtensionStore_ExtensionStore_Js.showPopover(this)" data-title="{vtranslate('LBL_WHAT_IS_SECURITY_CODE', $QUALIFIED_MODULE)}" data-content="{vtranslate('LBL_SECURITY_CODE_HELP_CONTENT', $QUALIFIED_MODULE)}" data-position="right"></span>
					</div>
				</div>
			</div>
