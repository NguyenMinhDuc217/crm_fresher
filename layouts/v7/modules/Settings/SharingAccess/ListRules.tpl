        ...
        <div class="title row">
            ...
            <div class="col-sm-6">
                <div class="pull-right">
                    {* Modified by Hieu Nguyen on 2022-03-01 to check forbidden feature *}
                    {if !isForbiddenFeature('EditSharingRules')}
                        <button class="btn btn-sm btn-default addButton addCustomRule" type="button" data-url="{$MODULE_MODEL->getCreateRuleUrl()}">
                        <i class="far fa-plus"></i> &nbsp;&nbsp;{vtranslate('LBL_ADD_CUSTOM_RULE', $QUALIFIED_MODULE)}
                        </button>
                    {/if}
                    {* End Hieu Nguyen *}
                </div>
                                        ...
                                        <td>
                                            ...
                                            {if !isForbiddenFeature('EditSharingRules')}
                                                <div class="table-actions pull-right">
                                                    <span><a href="javascript:void(0);" class="edit" data-url="{$RULE_MODEL->getEditViewUrl()}"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="far fa-pen"></i></a></span>
                                                    &nbsp;<span><a href="javascript:void(0);" class="delete" data-url="{$RULE_MODEL->getDeleteActionUrl()}"><i title="{vtranslate('LBL_DELETE', $MODULE)}" class="far fa-trash-alt"></i></a></span>
                                                </div>
                                            {/if}
                                            {* End Hieu Nguyen *}
                                        </td>
