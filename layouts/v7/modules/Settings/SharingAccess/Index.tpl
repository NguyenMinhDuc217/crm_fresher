    ...
    <div class="col-sm-12 col-xs-12">
        <form name="EditSharingAccess" action="index.php" method="post" class="form-horizontal" id="EditSharingAccess">
                            ...
                            <tr data-module-name="{$MODULE_MODEL->get('name')}">
                                ...
                                <td class="">
                                    ...
                                    <center>
                                        ...
                                        <div>
                                            <input type="radio" name="permissions[{$TABID}]" value="{$ACTION_ID}" 
                                                data-action-state="{$ACTION_MODEL->getName()}"
                                                {if $MODULE_MODEL->getPermissionValue() eq $ACTION_ID}checked="true"{/if}
                                                {if isForbiddenFeature('EditSharingRules')}disabled{/if}
                                            />
                                        </div>
                                        {* End Hieu Nguyen *}
                                    </center>
            ...
            {if !isForbiddenFeature('EditSharingRules')}
                <div class='modal-overlay-footer clearfix saveSharingAccess'>
