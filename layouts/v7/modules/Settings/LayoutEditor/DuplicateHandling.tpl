		...
		<form class="duplicateHandlingForm">
			...
			<div>
				<div class="vt-default-callout vt-info-callout"> 
					<h4 class="vt-callout-header"><span class="far fa-info-circle"></span>&nbsp;{vtranslate('LBL_INFO', 'vTiger')}</h4>
					...
					<div class="ruleBlock">
						...
						<div>
							...
							<span class="input-info-addon syncMessage">
								<a class="far fa-info-circle" data-toggle="tooltip" data-html="true" data-placement="right" title="{vtranslate('LBL_SYNC_TOOLTIP_MESSAGE', $QUALIFIED_MODULE)}"></a>
							</span>
						</div>
					</div>
					<br><br>
