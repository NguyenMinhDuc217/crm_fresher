...
{strip}
	...
	{include file='modules/Settings/LayoutEditor/tpls/RelationshipEditor.tpl'}
	{* End Hieu Nguyen *}
													...
													<li class="relatedModule module_{$MODULE_MODEL->getId()} border1px ONE_TO_MANY"  
														...
														<div class="row">
															<span class="col-sm-1" style="margin-top:18px;">
																<i class="far fa-grip-lines cursorPointerMove" title="{vtranslate('LBL_DRAG',$QUALIFIED_MODULE)}"></i>&nbsp;&nbsp;
															</span>
															...
															<div class="col-sm-1 deleteButton" style="padding-right: 0px;" data-relation="1">
																<div class="pull-right">
																	<button class="close" data-dismiss="modal" title="{vtranslate('LBL_CLOSE')}"><i class="far fa-times"></i></button>
																</div>
															</div>
														</div>
											...
											<div class="col-sm-10 relationListInfo" style="margin-left: 40px;">
												{if count($RELATED_MODULES) neq 0}
													<div style="margin: 5px 0px;">
														<div class="relatedListInfoHeader"><i class="far fa-info-circle"></i>&nbsp;{vtranslate('LBL_INFO', $QUALIFIED_MODULE)}</div><br>
