		...
		<div class="modal-content">
			<form class="form-horizontal createCustomFieldForm">
				...
				<div class="modal-body model-body-scrollenabled">
					...
					<div class="form-group">
						<label class="control-label fieldLabel col-sm-5">
							{vtranslate('LBL_FIELD_LABEL_DISPLAY_NAME_VN', $QUALIFIED_MODULE)} &nbsp;
							<span class="redColor">*</span>
						</label>
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9' name="fieldLabelDisplayVn" value="{$FIELD_MODEL->labelDisplayVn}" data-cur-value="{$FIELD_MODEL->labelDisplayVn}" data-rule-required='true' style='width: 75%' />
                            <input type="hidden" name="fieldLabelDisplayVnChanged" value="0" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label fieldLabel col-sm-5">
							{vtranslate('LBL_FIELD_LABEL_DISPLAY_NAME_EN', $QUALIFIED_MODULE)} &nbsp;
							<span class="redColor">*</span>
						</label>
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9' name="fieldLabelDisplayEn" value="{$FIELD_MODEL->labelDisplayEn}" data-cur-value="{$FIELD_MODEL->labelDisplayEn}" data-rule-required='true' style='width: 75%' />
                            <input type="hidden" name="fieldLabelDisplayEnChanged" value="0" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label fieldLabel col-sm-5">
						...
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9' maxlength="50" {if $IS_FIELD_EDIT_MODE}disabled{/if} name="fieldName" value="{$FIELD_MODEL->get('name')}" data-rule-required='true' style='width: 75%' />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label fieldLabel col-sm-5">
							{vtranslate('LBL_FIELD_LABEL_KEY_NAME', $QUALIFIED_MODULE)} &nbsp;
							<span class="redColor">*</span>
						</label>
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9' maxlength="50" name="fieldLabel" value="{$FIELD_MODEL->get('label')}" data-rule-required='true' style='width: 75%' {if $IS_FIELD_EDIT_MODE}disabled{/if}/>
						</div>
					</div>
					{* End Hieu Nguyen *}
					...
					<div class="well fieldProperty">
						<div class="properties">
							...
							<div class="row">
								<div class="form-group col-sm-7">
									<label class="control-label fieldLabel col-sm-10">
										<i class="far fa-exclamation-circle"></i> &nbsp; {vtranslate('LBL_MANDATORY_FIELD',$QUALIFIED_MODULE)}
									</label>
								...
								<div class="form-group col-sm-6">
									<label class="control-label fieldLabel col-sm-7">
										<i class="far fa-plus"></i>&nbsp;&nbsp;{vtranslate('LBL_QUICK_CREATE',$QUALIFIED_MODULE)}
									</label>
							...
							<div class="row">
								<div class="form-group col-sm-7">
									<label class="control-label fieldLabel col-sm-10">
										<i class="far fa-key"></i> &nbsp; {vtranslate('LBL_KEY_FIELD_VIEW',$QUALIFIED_MODULE)}
									</label>
									<div class="controls col-sm-2">
								...
								<div class="form-group col-sm-6">
									<label class="control-label fieldLabel col-sm-7">
										<i class="far fa-flag"></i> &nbsp; <span>{vtranslate('LBL_HEADER_FIELD',$QUALIFIED_MODULE)}</span>
									</label>
									<div class="controls col-sm-5">
