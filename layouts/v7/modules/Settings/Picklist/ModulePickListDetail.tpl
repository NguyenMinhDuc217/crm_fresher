    ...
    {else}
        <div class="row form-group">
			<div class="col-lg-3 col-md-3 col-sm-3 control-label fieldLabel">
                <label class="fieldLabel"><strong>{vtranslate('LBL_SELECT_PICKLIST_IN', $QUALIFIED_MODULE)}&nbsp;{vtranslate($SELECTED_MODULE_NAME, $SELECTED_MODULE_NAME)}</strong></label> {* Modified by Hieu Nguyen on 2021-06-18 to translate selected module name *}
            </div>
