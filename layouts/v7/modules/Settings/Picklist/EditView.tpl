            ...
            <form id="renameItemForm" class="form-horizontal" method="post" action="index.php">
                ...
                <div class="modal-body tabbable">
					...
					<div class="form-group">
						...
						<div class="controls col-sm-8 col-xs-8">
							<input type="text" name="itemLabelDisplayEn" value="{$LABEL_DISPLAY_EN}" data-cur-value="{$LABEL_DISPLAY_EN}" class="form-control" data-rule-required="true" style="max-width: 220px;"/>
                            <input type="hidden" name="itemLabelDisplayEnChanged" value="0" />
						</div>
					</div>
                    ...
                    <div class="form-group">
						...
						<div class="controls col-sm-8 col-xs-8">
							<input type="text" name="itemLabelDisplayVn" value="{$LABEL_DISPLAY_VN}" data-cur-value="{$LABEL_DISPLAY_VN}" class="form-control" data-rule-required="true" style="max-width: 220px;"/>
                            <input type="hidden" name="itemLabelDisplayVnChanged" value="0" />
						</div>
					</div>
                    {* End Hieu Nguyen *}
