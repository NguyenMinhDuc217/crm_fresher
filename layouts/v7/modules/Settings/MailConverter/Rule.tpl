	...
	<div class="mailConverterRuleBlock">
		<div class="details border1px">
			<div class="ruleHead modal-header" style="cursor: move; min-height: 30px; padding: 10px 0px;">
				<strong>
					<i class="far fa-grip-lines alignMiddle" style="margin-left: 10px;" ></i>&nbsp;&nbsp;{vtranslate('LBL_RULE', $QUALIFIED_MODULE)}&nbsp;<span class="sequenceNumber">{$RULE_COUNT}</span>&nbsp;:&nbsp;{vtranslate($RULE_MODEL->get('action'), $QUALIFIED_MODULE)}
