                ...
                <div class="modal-body" id="scrollContainer">
                    <div class="">
                        ...
                        <div class="row block regionsContainer {if $CHARGE_MODEL->get('type') neq 'Variable'}hide{/if}" style="padding: 0px 70px 0px 40px;">
                                ...
                                {foreach item=REGIONS_INFO name=i from=$CHARGE_MODEL->getSelectedRegions()}
                                    <tr>
                                        <td class="regionsList {$WIDTHTYPE}">
                                            <span class="deleteRow close" style="float:left;"><i class="far fa-times"></i></span>&nbsp;
                            ...
                            <br><br>
                            <div><i class="far fa-info-circle"></i> {vtranslate('LBL_TAX_BRACKETS_DESC', $QUALIFIED_MODULE)}</div>
                            <br><br>
                        </div>
                        ...
                        <div style="padding: 0px 40px;"><i class="far fa-info-circle"></i> {vtranslate('LBL_CHARGE_STORE_DISC', $QUALIFIED_MODULE)} ({Vtiger_Functions::getCurrencyName(CurrencyField::getDBCurrencyId())})</div>
                        <br><br>
                    </div>
                </div>
