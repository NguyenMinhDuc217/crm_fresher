									...
									<td class="{$WIDTHTYPE} fieldValue">
										<div class=" col-lg-6 col-md-6 col-sm-12">
											<select class="select2 inputElement col-lg-12 col-md-12 col-lg-12" name="serverType">
												...
												<option value="{"tls://smtp.mailgun.org:587"}" {if {$MODEL->get('server')} eq "tls://smtp.mailgun.org:587"} selected {/if}>{vtranslate('LBL_MAILGUN', $QUALIFIED_MODULE)}</option>
												...
												<option value="{"tls://smtp.office365.com:587"}" {if {$MODEL->get('server')} eq "tls://smtp.office365.com:587"} selected {/if}>{vtranslate('LBL_OFFICE365', $QUALIFIED_MODULE)}</option>
												...
												<option value="{"tls://smtp.zoho.com:587"}" {if {$MODEL->get('server')} eq "tls://smtp.zoho.com:587"} selected {/if}>{vtranslate('LBL_ZOHO', $QUALIFIED_MODULE)}</option>
