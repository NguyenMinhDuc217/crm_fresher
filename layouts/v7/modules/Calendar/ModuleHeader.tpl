...
{strip}
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content">
			<div class="col-lg-4 col-md-3 module-breadcrumb module-breadcrumb-{$smarty.request.view} transitionsAllHalfSecond"> {* Modified flex box width to 3-4 by Hieu Nguyen on 2020-02-14 *}
			...
			<div class="col-lg-8 col-md-9 pull-right"> {* Modified flex box width to 8-9 by Hieu Nguyen on 2020-02-14 *}
