...
Vtiger_Index_Js("Vtiger_TaskManagement_Js",{},{
	...
	getAllFilterParams : function(){
		...
		// Edited by Phu Vo on 2019.06.13 to process user filter value
		let userValues = jQuery('.otherFilters input[name="assigned_user_id"]').val();
		var userFilter = userValues ? userValues.split(',') : [];
		// End process user filter value
