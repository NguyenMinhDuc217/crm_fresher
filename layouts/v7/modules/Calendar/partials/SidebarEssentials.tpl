                ...
                <div class="calendar-sidebar-tab">
                    <div class="sidebar-widget-header" role="tab" data-url="{$SIDEBARWIDGET->getUrl()}">
                        <div class="sidebar-header clearfix">
                            {*<i class="far fa-chevron-right widget-state-indicator"></i>*}
                    ...
                    {* Added mass buttons by Hieu Nguyen on 2019-11-13 *}
                    <div class="text-right feed-mass-actions">
                        <label class="btn sidebar-btn" style="background: transparent" title="{vtranslate('LBL_FEED_MASS_ACTION_TOGGLE_ALL_TITLE', $MODULE)}">
                            <input type="checkbox" id="toggle-visible-all" class="mass-action" />
                        </label>
                        <button id="btn-remove-all" class="btn sidebar-btn mass-action" style="background: transparent" title="{vtranslate('LBL_FEED_MASS_ACTION_DELETE_ALL_TITLE', $MODULE)}">
                            <div class="far fa-trash-alt" aria-hidden="true"></div>
                        </button>
                    </div>
                    {* End Hieu Nguyen *}
