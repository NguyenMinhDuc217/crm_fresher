	...
	displayConvertPotentialModel : function(data, buttonElement) {
		...
		if(errorElement.length != '0') {
			...
			var callBackFunction = function(data){
				...
				// Added by Phu Vo on 2019.07.09 to trigger convert potential modal shown event
				app.event.trigger('post.convertPotentialModel.load', jQuery(data));
				// End trigger convert potential modal shown event
			}
