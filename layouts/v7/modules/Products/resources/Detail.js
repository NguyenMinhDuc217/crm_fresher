...
PriceBooks_Detail_Js("Products_Detail_Js", {
    ...
    registerEventForImageGraphics: function() {
        if (jQuery('#imageContainer').find("img").length > 0) {
            ...
            jQuery('.bx-next').addClass("far fa-arrow-right");
            jQuery('.bx-prev').css({"font-size": "20px", "color": "gray"});
            jQuery('.bx-prev').addClass("far fa-arrow-left");
        }
    },
    ...
    registerBasicEvents: function(){
        this._super();
        // this.registerEventForImageGraphics(); // Comment out unused code by Phu Vo on 2019.09.17
    },
    /**
