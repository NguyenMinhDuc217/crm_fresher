								...
								<tr data-currency-id={$price.curname}>
									...
									<td>
										<div class = "textAlignCenter">
											<button {$disable_value} type="button" class="btn btn-default currencyReset" id="cur_reset{$price.curid}" value="{vtranslate('LBL_RESET',$MODULE)}"><i class = "far fa-refresh"></i>&nbsp;&nbsp;{vtranslate('LBL_RESET',$MODULE)}</button>
										</div>
									</td>
									<td>
										<div class="textAlignCenter">
