    ...
    <div class="col-sm-6 col-lg-6 col-md-6">
        <div class="record-header clearfix">
            ...
            <div class="recordBasicInfo">
                ...
                <div class="info-row row">
                    {assign var=FIELD_MODEL value=$MODULE_MODEL->getField('active')}
                    <div class="col-lg-7 fieldLabel">
                        <span class="active" title="{vtranslate($FIELD_MODEL->get('label'),$MODULE)} : {if $RECORD->get('active') eq 1} Active {else} Inactive {/if}">{if $RECORD->get('active') eq 1} Active {else} Inactive {/if}</span>
                    </div>
                </div>
