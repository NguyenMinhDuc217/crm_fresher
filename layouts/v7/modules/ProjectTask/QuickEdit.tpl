                        ...
                        <table class="massEditTable table no-border">
                            <tr>
                                ...
                                {foreach key=FIELD_NAME item=FIELD_MODEL from=$RECORD_STRUCTURE name=blockfields}
                                    ...
                                    <td class="fieldValue {$FIELD_NAME}" {if $FIELD_MODEL->get('uitype') eq '19'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}> {* Edited by Phu Vo on 2019.06.17 => Add field name *}
