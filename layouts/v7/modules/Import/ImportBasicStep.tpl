				...
				<div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
					...
					{else}
						...
						<div id="importStepTwoButtonsDiv" class = "hide">
							...
							&nbsp;&nbsp;&nbsp;<button class="btn btn-primary btn-lg" id="skipDuplicateMerge" onclick="Vtiger_Import_Js.uploadAndParse('0');">{vtranslate('LBL_SKIP_THIS_STEP', $MODULE)}</button>   {* Modified by Hieu Nguyen on 2020-09-10 to display the right label *}
							&nbsp;&nbsp;&nbsp;<a class='cancelLink' data-dismiss="modal" href="#">{vtranslate('LBL_CANCEL', $MODULE)}</a>
						</div>
					{/if}
				</div>
