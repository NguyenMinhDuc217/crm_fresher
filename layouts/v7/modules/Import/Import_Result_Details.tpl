...
<table width="100%" class="table table-borderless">
    ...
    {* Added by Hieu Nguyen on 2020-09-10 to show cancelled records *}
    {if $IMPORT_RESULT.CANCELLED != '0'}
		<tr>
			<td><font color="red">{vtranslate('LBL_TOTAL_RECORDS_CANCELLED', $MODULE)}</font></td>
			<td width="10%">:</td>
			<td width="30%"><font color="red">{$IMPORT_RESULT.CANCELLED} / {$IMPORT_RESULT.TOTAL}</font></td>
		</tr>
	{/if}
    {* End Hieu Nguyen *}
</table>