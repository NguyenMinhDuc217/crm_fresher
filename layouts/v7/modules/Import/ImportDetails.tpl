		...
		<div class="modal-body">
			<div id="popupPageContainer" class="contentsDiv import-details-container">
				<div id="popupContents" class="paddingLeftRight10px">
					...
					<div class="pull-right"><a class="btn btn-primary" href="index.php?module=Import&action=ExportErrors&target_module={$IMPORT_RECORDS['headers'][0]->getModule()->getName()}&error_type={$TYPE}"><i class="far fa-lg fa-download"></i>&nbsp;{vtranslate('LBL_DOWNLOAD', 'Vtiger')}</a></div>
                    {* End Hieu Nguyen *}
