            ...
            <div class="filePreview container-fluid">
                <div class="modal-header row">
                    <div class="filename {if $FILE_PREVIEW_NOT_SUPPORTED neq 'yes'} col-lg-8 {else} col-lg-11 {/if}">
                        <h4 style="margin-top:0px;"><b>{$FILE_NAME}</b></h4>
                    </div>
                    ...
                    <div class="col-lg-1">
                        <button data-dismiss="modal" class="close pull-right" title="close"> 
                            <span aria-hidden="true" class='far fa-close'></span></button>
                    </div>
                </div>
                    ...
                    {else}
                        {if $BASIC_FILE_TYPE eq 'yes'}
                            <div style="overflow:auto;height:100%;">
                                <pre>
                                    {strip_tags($FILE_CONTENTS)}    {* [Security] Modified by Hieu Nguyen on 2020-03-03 to fix bug rendering HTML content *}
                                </pre>
                            </div>
