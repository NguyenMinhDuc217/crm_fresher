...
{strip}
<div class="modal-dialog modal-lg modelContainer QuickCreate"> {* Edited by Phu Vo on 2019.06.18 to resize model to large size *}
					...
					<table class="massEditTable table no-border">
						...
						<tr>
							...
							{foreach key=FIELD_NAME item=FIELD_MODEL from=$FIELD_MODELS}
								{if !in_array($FIELD_NAME,$HARDCODED_FIELDS) && $FIELD_MODEL->isQuickCreateEnabled() && $FIELD_MODEL->isEditable()} {* [Vtiger] Check editable on preference fields *}
