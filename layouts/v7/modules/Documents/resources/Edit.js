...
Vtiger_Edit_Js("Documents_Edit_Js", {
	...
	registerFileElementChangeEvent : function(container) {
		...
		container.on('change', 'input[name="filename"]', function(e){
            ...
            if (typeof _VALIDATION_CONFIG.allowed_upload_file_exts == 'undefined' || _VALIDATION_CONFIG.allowed_upload_file_exts.indexOf(fileExt) < 0) {
   ...
   registerCustomValidationForFileElement : function(container) {
    ...
    registerBasicEvents : function(container) {
        ...
        // Updated by Phuc on 2019.10.10 to prevent duplicate action and refactor code
