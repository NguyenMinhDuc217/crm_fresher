...
{strip}
    <script src="{vresource_url('modules/Users/resources/PasswordValidator.js')}"></script>
                    ...
                    <div class="modal-body ">
                        <div class="form-group">
                            ...
                            <div class="controls col-sm-6">
                                <input type="text" name="new_username" class="inputElement" data-rule-required="true" data-rule-illegal="true"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-xs-6">
                                <input type="password" name="new_password" class="inputElement" data-rule-required="true"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-xs-6">
                                <input type="password" name="confirm_password" class="inputElement" data-rule-required="true"/>
                            </div>
                        </div>
                    </div>
                </div>
