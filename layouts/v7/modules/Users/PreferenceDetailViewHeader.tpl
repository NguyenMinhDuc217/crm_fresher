			...
			<div class="col-lg-12 col-sm-12 col-xs-12">
				<div class="col-xs-8">
					...
					{if $IMAGE_DETAILS[0]['id'] eq null}
						<span class="logo col-xs-2">
							{* Modified by Phu Vo on 2021.05.21 to change default user avatar *}
							<img height="75px" width="75px" src="resources/images/default-user-avatar.png" alt="{$IMAGE_INFO.orgname}" title="{$IMAGE_INFO.orgname}" data-image-id="{$IMAGE_INFO.id}">
							{* End Phu Vo *}
						</span>
					{/if}
					<span class="col-xs-9">
