					...
					<tr data-module-name="Calendar">
						...
						<td>
							<div class="row-fluid">
								<div class="span3">&nbsp;</div>
								<div class="span6">
									<button type="button" class="btn btn-sm vtButton arrowDown row-fluid" disabled="disabled" ><img src="layouts/vlayout/skins/images/Arrow-down.png"></img></button>
								</div>
							</div>
						</td>
					</tr>
					...
					<tr data-module-name="{$MODULE_MODEL->get('name')}">
						...
						<td class="triggerCustomSharingAccess">
							<div class="row-fluid">
								<div class="span3">&nbsp;</div>
								<div class="span6">
									<button type="button" class="btn btn-sm vtButton arrowDown row-fluid" data-handlerfor="fields" data-togglehandler="{$TABID}-rules"><img src="layouts/vlayout/skins/images/Arrow-down.png"></img></button>
									<button type="button" class="btn btn-sm vtButton arrowUp row-fluid hide" data-handlerfor="fields" data-togglehandler="{$TABID}-rules"><img src="layouts/vlayout/skins/images/Arrow-up.png"></img></button>
								</div>
							</div>
						</td>
					</tr>
