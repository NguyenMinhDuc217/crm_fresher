...
class VTEntityDelta extends VTEventHandler {
	...
	function handleEvent($eventName, $entityData) {
		...
		if($eventName == 'vtiger.entity.beforesave') {
            // Added by Hieu Nguyen on 2019-05-21 to set value for custom owner field
            Vtiger_CustomOwnerField_Helper::setOwner($entityData);
            // End Hieu Nguyen
		...
		if($eventName == 'vtiger.entity.aftersave'){
            ...
            // Added by Hieu Nguyen on 2019-05-24 to handle custom owner field
            Vtiger_CustomOwnerField_Helper::updateMainOwner($entityData);
            Vtiger_CustomOwnerField_Helper::deleteCustomGroupIfNotUsed($_REQUEST['current_owner_id']);
            // End Hieu Nguyen
		}
	}
