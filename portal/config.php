...
class Portal_Config_Data {
	...
	protected static $data = array(
		...
		'crm.url' => 'http://localhost/vtiger',

		//Portal URL without trialing/
		//Example: http://yourdomain.com/portal
		'portal.url' => 'http://localhost/vtiger/portal',

		'crm.version' => '7.1.0', // Framework version for API
		'language' => 'vn_vn', // Default Language for API. Note : Changing the language here will not change the default/login language for Portal user.
		'layout' => 'default',
	);
	...
	protected static function getData() {
		...
		self::$data['ui.Language'] = array('label' => 'Tiếng Việt | Vietnamese', 'value' => 'vn_vn');
		...
		self::$data['languages'] = array(
			...
			array('label' => 'Tiếng Việt | Vietnamese', 'value' => 'vn_vn'),
